...
const char *const kValidSchemes[] = {url::kHttpScheme,
                                     url::kHttpsScheme,
                                     url::kFileScheme,
                                     url::kFtpScheme,
...
URLPattern::URLPattern()
    : valid_schemes_(SCHEME_NONE), match_all_urls_(false),
      match_subdomains_(false), port_("*") {}
...
absl::optional<URLPattern>
URLPattern::CreateIntersection(const URLPattern &other) const {
...
// static
const char *
URLPattern::GetParseResultString(URLPattern::ParseResult parse_result) {
