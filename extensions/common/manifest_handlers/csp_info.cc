...
// static
const std::string *
CSPInfo::GetDefaultCSPToAppend(const Extension &extension,
...
// static
const std::string &
CSPInfo::GetSandboxContentSecurityPolicy(const Extension *extension) {
  CSPInfo *csp_info = static_cast<CSPInfo *>(
      extension->GetManifestData(keys::kContentSecurityPolicy));
...
// static
const std::string &
CSPInfo::GetResourceContentSecurityPolicy(const Extension *extension,
                                          const std::string &relative_path) {
...
bool CSPHandler::ParseExtensionPagesCSP(
    Extension *extension, std::u16string *error, base::StringPiece manifest_key,
...
bool CSPHandler::ParseSandboxCSP(Extension *extension, std::u16string *error,
