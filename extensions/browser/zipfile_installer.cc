...
PrepareAndGetUnzipDir(const base::FilePath &zip_file) {
...
void ZipFileInstaller::ManifestUnzipped(const base::FilePath &unzip_dir,
  ...
  new_unzip_dir = unzip_dir.Append(FILE_PATH_LITERAL("/"))
                      .Append(additional_path)
...
void ZipFileInstaller::ManifestRead(
  ...
  LOG(INFO) << "[EXTENSIONS] ZipFileInstaller::ManifestRead - B";
...
void ZipFileInstaller::UnzipDone(const base::FilePath &unzip_dir,
  ...
  base::FilePath new_unzip_dir;
  new_unzip_dir =
      unzip_dir.Append(FILE_PATH_LITERAL("/")).Append(additional_path);
...
bool ZipFileInstaller::IsManifestFile(const base::FilePath &file_path) {
  ...
  if (base::FilePath::CompareEqualIgnoreCase(file_path.BaseName().value(),
                                             kManifestFilename)) {
    LOG(INFO)
        << "[EXTENSIONS] ZipFileInstaller::IsManifestFile (isManifest: true): "
