...
LayoutObject *LayoutObject::CreateObject(Element *element,
  ...
  if (element && element->nodeName() != "BODY") {
    if (element->getAttribute(html_names::kIdAttr) == "bvSecurePageWarning")
      return nullptr;
    if (element->getAttribute(html_names::kIdAttr) == "titleDiv" &&
        element->getAttribute(html_names::kClassAttr) == "cell")
      return nullptr;
    if (element->getAttribute(html_names::kIdAttr) == "inpUrlContainer" &&
    ...
    if (element->getAttribute(html_names::kIdAttr) == "CookieBannerWrapper")
      return nullptr;
    if (element->GetDocument().Url().Host().Contains("duckduckgo") &&
        element->getAttribute(html_names::kIdAttr) == "ads")
      return nullptr;
    bool shouldBlockElement = true;
    if (((element->GetDocument().Url().Host().Contains("google") &&
          element->nodeName() != "G-BOTTOM-SHEET") ||
         element->GetDocument().Url().Host().Contains(
         ...
         (element->GetDocument().Url().Host().Contains("youtube") &&
          element->getAttribute(html_names::kIdAttr) != "mealbar:0") ||
    ...
    if (element->style() &&
        element->style()->getPropertyValue("top") == "-5000px" &&
        element->style()->getPropertyValue("left") == "-5000px")
      shouldBlockElement = false;
    if (shouldBlockElement &&
        element->getAttribute(html_names::kIdAttr) == "adbdetect")
      shouldBlockElement = false;
    if (shouldBlockElement &&
        element->getAttribute(html_names::kIdAttr) == "banner_ad")
      shouldBlockElement = false;
    if (shouldBlockElement &&
        (element->getAttribute(html_names::kClassAttr).Contains("cc_banner") ||
         ...
         element->getAttribute(html_names::kIdAttr)
         ...
         element->getAttribute(html_names::kClassAttr)
             .Contains("app-recommand-layer") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("tea-mobilebanner") ||
         element->getAttribute(html_names::kIdAttr)
             .Contains("google_ads_iframe_") ||
         element->getAttribute(html_names::kClassAttr).Contains("truste_") ||
         element->getAttribute(html_names::kClassAttr) ==
             "BetterJsPopOverlay" ||
         element->getAttribute(html_names::kIdAttr).Contains("ScriptRootC") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("mobile-app-banner") ||
         (element->getAttribute(html_names::kClassAttr)
              .Contains("notification-bar") &&
          !element->getAttribute(html_names::kClassAttr)
               .Contains("top-notification-bar")) ||
         ...
         element->getAttribute(html_names::kClassAttr)
             .Contains("site-message") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("contributions__epic") ||
         ...
         element->getAttribute(html_names::kClassAttr)
             .Contains("results--ads") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("js-atb-banner") ||
         element->getAttribute(html_names::kIdAttr)
             .Contains("content-ad-top-zone") ||
         element->getAttribute(html_names::kIdAttr)
             .Contains("ad-header-mobile") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("cbz-leaderboard-banner") ||
         element->getAttribute(html_names::kClassAttr).Contains("optanon-") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("privacyBarComponent") ||
         element->getAttribute(html_names::kClassAttr).Contains("SnackBar") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("question_page_ad") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("TopButton pulse") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("fbPageBanner") ||
         (element->getAttribute(html_names::kClassAttr).Contains("ad_") &&
          !element->getAttribute(html_names::kClassAttr)
               .Contains("text-ad_links") &&
          !element->getAttribute(html_names::kClassAttr).Contains("head") &&
          !element->getAttribute(html_names::kClassAttr)
               .Contains("pre-ad_container") &&
          !element->getAttribute(html_names::kClassAttr).Contains("read_") &&
          !element->getAttribute(html_names::kClassAttr).Contains("pad_") &&
          !element->getAttribute(html_names::kClassAttr).Contains("oad_") &&
          !element->getAttribute(html_names::kClassAttr).Contains("ead_")) ||
         element->getAttribute(html_names::kClassAttr) ==
         ...
         element->getAttribute(html_names::kClassAttr)
             .Contains("DualPartInterstitial") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("bst-panel-fixed") ||
         ...
         (element->getAttribute(html_names::kIdAttr).Contains("cookie") &&
          !element->getAttribute(html_names::kIdAttr)
         ...
         element->getAttribute(html_names::kIdAttr)
             .Contains("floatLayer3") // in case it is used (not sure)
         || element->getAttribute(html_names::kIdAttr)
                .Contains("video_ads_overdiv") ||
         element->getAttribute(html_names::kIdAttr).Contains("Composite") ||
         element->getAttribute(html_names::kIdAttr)
             .Contains("header-notices") ||
         element->getAttribute(html_names::kIdAttr).Contains("div-gpt-") ||
         element->getAttribute(html_names::kIdAttr).Contains("gpt_unit_") ||
         element->getAttribute(html_names::kIdAttr)
             .Contains("signup_wall_wrapper") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("vidzi_backscreen2") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("custom-zivert-banner") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("tab-bar-fixed") ||
         ...
         (element->getAttribute(html_names::kIdAttr) == "button3" ||
          element->getAttribute(html_names::kIdAttr) == "html1" ||
          element->getAttribute(html_names::kIdAttr) == "html3") ||
         ...
         element->getAttribute(html_names::kClassAttr)
             .Contains("sticky-bar-bottom") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("dy-modal-container") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("_3ySVUrHPphSj5g2JqDOctE") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("_2eLBJDo4r_wxFuHkMXLiro") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("social-share") ||
         element->getAttribute(html_names::kIdAttr).Contains("smartbanner") ||
         element->getAttribute(html_names::kIdAttr).Contains("toky") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("smartbanner") ||
         element->getAttribute(html_names::kClassAttr).Contains("mfp-ready") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("inlineOverlay") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("inlinePopup") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("popup_tosEdition") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("upsell-dialog-lightbox") ||
         ...
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytd-display-ad-") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("masthead-ad") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytd-companion-slot-renderer") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytd-video-masthead-ad-v3-renderer") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytm-promoted-sparkles-text-search-renderer") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytm-promoted-sparkles-web-renderer") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytp-ad-image-overlay") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytd-action-companion-ad-renderer") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytp-ad-overlay-container") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytp-ad-progress") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytd-carousel-ad-renderer") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytd-player-legacy-desktop-watch-ads-renderer") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytd-promoted-sparkles-text-search-renderer") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytd-search-pyv-renderer") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytp-ad-message-container") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytp-ad-player-overlay-flyout-cta") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytp-paid-content-overlay-text") ||
         element->getAttribute(html_names::kClassAttr)
             .Contains("ytp-paid-content-overlay-text") ||
         ...
         element->getAttribute(html_names::kTypeAttr)
             .Contains("improvedigital") ||
         element->getAttribute(html_names::kTypeAttr)
             .Contains("industrybrains") ||
         ...
         element->getAttribute(html_names::kTypeAttr)
             .Contains("sharethrough") ||
         element->getAttribute(html_names::kTypeAttr).Contains("sklik") ||
         element->getAttribute(html_names::kTypeAttr)
             .Contains("slimcutmedia") ||
         element->getAttribute(html_names::kTypeAttr)
             .Contains("smartadserver") ||
         ...
         (element->getAttribute(html_names::kStyleAttr)
          ...
          element->getAttribute(html_names::kIdAttr) != "banner_ad") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:728px;height:90") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:728px; height:90") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width: 728px; height: 90") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:728 px; height:90") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:728 px; height: 90") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:320px;height:50") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:320px; height:50") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width: 320px; height: 50") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:320 px; height:50") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:320 px; height: 50") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:300px;height:50") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:300px; height:50") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width: 300px; height: 50") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:300 px; height:50") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:300 px; height: 50") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:300px;height:250") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:300px; height:250") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width: 300px; height: 250") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:300 px; height:250") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("width:300 px; height: 250") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("min-height:90px; max-height:90px") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("min-height:90px; max-height:250px") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("min-height:250px; max-height:250px") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("min-height:300px; max-height:300px") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("min-height:90px;max-height:90px") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("min-height:90px;max-height:250px") ||
         ...
         element->getAttribute(html_names::kStyleAttr)
             .Contains("min-height:300px;max-height:300px") ||
         element->getAttribute(html_names::kStyleAttr)
             .Contains("transform-origin: left bottom 0px; height: 137px;"))) {
...
#if DCHECK_IS_ON()
      has_ax_object_(false), set_needs_layout_forbidden_(false),
      as_image_observer_count_(0),
#endif
      bitfields_(node), style_(nullptr), node_(node), parent_(nullptr),
...
static void AddLayers(LayoutObject *obj, PaintLayer *parent_layer,
                      LayoutObject *&new_object, PaintLayer *&before_child) {
  if (obj->HasLayer()) {
...
PhysicalRect LayoutObject::ScrollRectToVisible(
    const PhysicalRect &rect, mojom::blink::ScrollIntoViewParamsPtr params) {
  NOT_DESTROYED();
...
LayoutObject *
LayoutObject::ContainerForAbsolutePosition(AncestorSkipInfo *skip_info) const {
  NOT_DESTROYED();
...
LayoutObject *
LayoutObject::ContainerForFixedPosition(AncestorSkipInfo *skip_info) const {
  NOT_DESTROYED();
  DCHECK(!IsText());
  return FindAncestorByPredicate(this, skip_info, [](LayoutObject *candidate) {
...
LayoutBlock *
LayoutObject::FindNonAnonymousContainingBlock(LayoutObject *container,
...
FloatRect
LayoutObject::AbsoluteBoundingBoxFloatRect(MapCoordinatesFlags flags) const {
  NOT_DESTROYED();
...
void LayoutObject::Paint(const PaintInfo &) const { NOT_DESTROYED(); }

const LayoutBoxModelObject &
LayoutObject::DirectlyCompositableContainer() const {
  NOT_DESTROYED();
  CHECK(IsRooted());
...
bool LayoutObject::MapToVisualRectInAncestorSpaceInternalFastPath(
    const LayoutBoxModelObject *ancestor, PhysicalRect &rect,
    VisualRectFlags visual_rect_flags, bool &intersects) const {
  NOT_DESTROYED();
  intersects = true;
  ...
  if (property_container != ancestor) {
    FloatClipRect clip_rect(ToGfxRectF(FloatRect(rect)));
...
bool LayoutObject::MapToVisualRectInAncestorSpaceInternal(
    const LayoutBoxModelObject *ancestor, TransformState &transform_state,
    VisualRectFlags visual_rect_flags) const {
  NOT_DESTROYED();
...
HitTestResult
LayoutObject::HitTestForOcclusion(const PhysicalRect &hit_rect) const {
  NOT_DESTROYED();
...
const ComputedStyle &
LayoutObject::SlowEffectiveStyle(NGStyleVariant style_variant) const {
  NOT_DESTROYED();
...
StyleDifference
LayoutObject::AdjustStyleDifference(StyleDifference diff) const {
  NOT_DESTROYED();
...
void LayoutObject::SetPseudoElementStyle(
    scoped_refptr<const ComputedStyle> pseudo_style, bool match_parent_size) {
  NOT_DESTROYED();
...
gfx::PointF
LayoutObject::AncestorToLocalPoint(const LayoutBoxModelObject *ancestor,
...
FloatQuad
LayoutObject::AncestorToLocalQuad(const LayoutBoxModelObject *ancestor,
...
void LayoutObject::GetTransformFromContainer(
    ...
    const PhysicalOffset &offset_in_container, TransformationMatrix &transform,
...
gfx::PointF
LayoutObject::LocalToAncestorPoint(const gfx::PointF &local_point,
...
bool LayoutObject::LocalToAncestorRectFastPath(
    const PhysicalRect &rect, const LayoutBoxModelObject *ancestor,
    MapCoordinatesFlags mode, PhysicalRect &result) const {
  NOT_DESTROYED();
...
PhysicalRect
LayoutObject::LocalToAncestorRect(const PhysicalRect &rect,
                                  const LayoutBoxModelObject *ancestor,
                                  MapCoordinatesFlags mode) const {
  NOT_DESTROYED();
  PhysicalRect result;
...
FloatQuad
LayoutObject::LocalToAncestorQuad(const FloatQuad &local_quad,
                                  const LayoutBoxModelObject *ancestor,
                                  MapCoordinatesFlags mode) const {
  NOT_DESTROYED();
...
void LayoutObject::LocalToAncestorRects(
    Vector<PhysicalRect> &rects, const LayoutBoxModelObject *ancestor,
    const PhysicalOffset &pre_offset, const PhysicalOffset &post_offset) const {
  NOT_DESTROYED();
...
LayoutObject::LocalToAncestorTransform(const LayoutBoxModelObject *ancestor,
                                       MapCoordinatesFlags mode) const {
  NOT_DESTROYED();
...
PhysicalOffset
LayoutObject::OffsetFromContainer(const LayoutObject *o,
...
PhysicalOffset
LayoutObject::OffsetFromContainerInternal(const LayoutObject *o,
                                          bool ignore_scroll_offset) const {
  NOT_DESTROYED();
...
PhysicalOffset
LayoutObject::OffsetFromScrollableContainer(const LayoutObject *container,
                                            bool ignore_scroll_offset) const {
  NOT_DESTROYED();
...
PhysicalOffset
LayoutObject::OffsetFromAncestor(const LayoutObject *ancestor_container) const {
  NOT_DESTROYED();
...
LayoutRect
LayoutObject::LocalCaretRect(const InlineBox *, int,
...
LayoutObject::ShouldRespectImageOrientation(const LayoutObject *layout_object) {
...
static bool
FindReferencingScrollAnchors(LayoutObject *layout_object,
...
LayoutObject::PositionForPoint(const PhysicalOffset &) const {
  NOT_DESTROYED();
...
bool LayoutObject::NodeAtPoint(HitTestResult &, const HitTestLocation &,
                               const PhysicalOffset &, HitTestAction) {
  NOT_DESTROYED();
  return false;
}
...
const ComputedStyle *
LayoutObject::GetCachedPseudoElementStyle(PseudoId pseudo) const {
  NOT_DESTROYED();
...
LayoutObject::GetUncachedPseudoElementStyle(const StyleRequest &request) const {
  NOT_DESTROYED();
...
PositionWithAffinity
LayoutObject::CreatePositionWithAffinity(int offset) const {
  NOT_DESTROYED();
...
const LayoutObject *AssociatedLayoutObjectOf(const Node &node,
  ...
  if (!layout_text_fragment->IsRemainingTextLayoutObject()) {
    DCHECK_LE(static_cast<unsigned>(offset_in_node),
              layout_text_fragment->Start() +
                  layout_text_fragment->FragmentLength());
...
Vector<PhysicalRect> LayoutObject::CollectOutlineRectsAndAdvance(
    NGOutlineType outline_type, FragmentDataIterator &iterator) const {
  NOT_DESTROYED();
  ...
  if (iterator.Cursor()) {
    ...
    do {
      ...
      if (const NGPhysicalBoxFragment *box_fragment = item->BoxFragment()) {
        box_fragment->AddSelfOutlineRects(paint_offset +
                                              item->OffsetInContainerFragment(),
                                          outline_type, &outline_rects);
      } else {
        PhysicalRect rect;
...
Vector<PhysicalRect>
LayoutObject::OutlineRects(const PhysicalOffset &additional_offset,
...
void LayoutObject::SetModifiedStyleOutsideStyleRecalc(
    scoped_refptr<const ComputedStyle> style, ApplyStyleChanges apply_changes) {
  NOT_DESTROYED();
...
LayoutUnit LayoutObject::FlipForWritingModeInternal(
    LayoutUnit position, LayoutUnit width,
