...
/**
 * Implementation of {@link HybridListRenderer} for list consisting all native
 * views.
 */
public class NativeViewListRenderer
    extends RecyclerView.Adapter<NativeViewListRenderer.ViewHolder>
  ...
  public NativeViewListRenderer(Context mContext) { this.mContext = mContext; }
