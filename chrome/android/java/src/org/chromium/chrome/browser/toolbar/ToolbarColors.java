...
public class ToolbarColors {
  /**
   * Returns whether the incognito toolbar theme color can be used in overview
   * mode.
   * @param context The activity context.
   */
  public static boolean
  canUseIncognitoToolbarThemeColorInOverview(Context context) {
    ...
    if (ContextUtils.getAppSharedPreferences()
        ...
        ContextUtils.getAppSharedPreferences()
            ...
            .equals("horizontal"))
      return true;
    return (isAccessibilityEnabled || isTabGridEnabled ||
