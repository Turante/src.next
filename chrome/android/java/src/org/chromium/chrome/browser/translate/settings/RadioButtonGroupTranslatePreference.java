...
/**
 * A radio button group Preference used for Translate Preference. It contains 2
...
public final class RadioButtonGroupTranslatePreference
  ...
  static class PreferenceValues {
     ...
     * RadioButtonGroupTranslatePreference}.
     */
  ...
  public RadioButtonGroupTranslatePreference(Context context,
                                             AttributeSet attrs) {
    super(context, attrs);
  ...
  public void onCheckedChanged(RadioGroup group, int checkedId) {
    ...
    RadioButtonWithDescription mChoice_google_translate =
        (RadioButtonWithDescription)mHolder.findViewById(
            R.id.radio_button_google_translate);
    RadioButtonWithDescription mChoice_microsoft_translator =
        (RadioButtonWithDescription)mHolder.findViewById(
            R.id.radio_button_microsoft_translator);
    RadioButtonWithDescription mChoice_yandex_translator =
        (RadioButtonWithDescription)mHolder.findViewById(
            R.id.radio_button_yandex_translator);
    RadioButtonWithDescription mChoice_baidu_fanyi =
        (RadioButtonWithDescription)mHolder.findViewById(
            R.id.radio_button_baidu_fanyi);
  ...
  public void onBindViewHolder(PreferenceViewHolder holder) {
    ...
    if (ContextUtils.getAppSharedPreferences().getString("active_translator",
                                                         "Default") == "" ||
        ContextUtils.getAppSharedPreferences().getString(
            "active_translator", "Default") == "Default")
    ...
    if (ContextUtils.getAppSharedPreferences().getString(
            "active_translator", "Default") == "Microsoft Translator")
