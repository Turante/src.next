...
public class TabSwitcherSettings extends PreferenceFragmentCompat {
  ...
  @VisibleForTesting
  public static final String PREF_TABSWITCHER_RADIO_GROUP =
      "tabswitcher_radio_group";
  ...
  public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
    ...
    SettingsUtils.addPreferencesFromResource(this,
                                             R.xml.tabswitcher_preferences);

    mRadioButtons = (RadioButtonGroupTabSwitcherPreference)findPreference(
        PREF_TABSWITCHER_RADIO_GROUP);
  ...
  private PreferenceValues createPreferenceValuesForRadioGroup() {
    String checkedOption = ContextUtils.getAppSharedPreferences().getString(
        "active_tabswitcher", "default");
