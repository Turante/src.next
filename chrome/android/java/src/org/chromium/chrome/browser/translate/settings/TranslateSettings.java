...
public class TranslateSettings extends PreferenceFragmentCompat {
  ...
  @VisibleForTesting
  public static final String PREF_TRANSLATE_RADIO_GROUP =
      "translate_radio_group";
  ...
  public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
    ...
    mRadioButtons = (RadioButtonGroupTranslatePreference)findPreference(
        PREF_TRANSLATE_RADIO_GROUP);
