...
/**
 * A radio button group Preference used for TabSwitcher Preference. It contains
 * 2 options: a {@link RadioButtonWithDescription} that represent Chrome NTP,
 * and a
...
public final class RadioButtonGroupTabSwitcherPreference
  ...
  static class PreferenceValues {
     ...
     * RadioButtonGroupTabSwitcherPreference}.
     */
  ...
  public RadioButtonGroupTabSwitcherPreference(Context context,
                                               AttributeSet attrs) {
    super(context, attrs);
  ...
  public void onCheckedChanged(RadioGroup group, int checkedId) {
    ...
    RadioButtonWithDescription mChoice_original =
        (RadioButtonWithDescription)mHolder.findViewById(
            R.id.radio_button_original);
    RadioButtonWithDescription mChoice_horizontal =
        (RadioButtonWithDescription)mHolder.findViewById(
            R.id.radio_button_horizontal);
    RadioButtonWithDescription mChoice_classic =
        (RadioButtonWithDescription)mHolder.findViewById(
            R.id.radio_button_classic);
    RadioButtonWithDescription mChoice_list =
        (RadioButtonWithDescription)mHolder.findViewById(
            R.id.radio_button_list);
    RadioButtonWithDescription mChoice_grid =
        (RadioButtonWithDescription)mHolder.findViewById(
            R.id.radio_button_grid);
    ...
    ContextUtils.getAppSharedPreferences()
        .edit()
        .putBoolean("accessibility_tab_switcher", false)
        .apply();
  ...
  public void onBindViewHolder(PreferenceViewHolder holder) {
    ...
    RadioButtonWithDescription mChoice_classic =
        (RadioButtonWithDescription)holder.findViewById(
            R.id.radio_button_classic);
    RadioButtonWithDescription mChoice_list =
        (RadioButtonWithDescription)holder.findViewById(R.id.radio_button_list);
    RadioButtonWithDescription mChoice_grid =
        (RadioButtonWithDescription)holder.findViewById(R.id.radio_button_grid);
    ...
    mChoice_original.setPrimaryText(
        "Original (vertical, same as old Chromium)");
    if (ContextUtils.getAppSharedPreferences()
            .getString("active_tabswitcher", "default")
            .equals("original"))
