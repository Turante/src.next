...
/**
 * An empty implementation of {@link TabModelFilter} interface. This is a {@link
 * TabList} that contains the same {@link Tab}s as {@link TabModel} does.
 */
public class EmptyTabModelFilter extends TabModelFilter {
  public EmptyTabModelFilter(TabModel tabModel) { super(tabModel); }
