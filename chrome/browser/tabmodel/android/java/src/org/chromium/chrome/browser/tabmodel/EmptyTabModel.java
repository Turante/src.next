...
public class EmptyTabModel implements TabModel {
  /**
   * Used to mock TabModel. Application code should use getInstance() to
   * construct an EmptyTabModel.
   */
  @VisibleForTesting
   ...
   */
  public static EmptyTabModel getInstance() { return LazyHolder.INSTANCE; }
