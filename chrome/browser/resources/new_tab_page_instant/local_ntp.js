...
function LocalNTP() {
  ...
  function addRippleAnimations() {
    let ripple = (event) => {
      ...
      let cornerDistances = corners.map(function(
          corner) { return Math.round(distance(x, y, corner.x, corner.y)); });
      const radius =
  ...
  var loadDoodle = function(v, onload) {
    ...
    if (v !== null)
      ddlScript.src += '?v=' + v;
    ddlScript.onload = function() { onload(ddl); };
    ddlScript.onerror = function() { onload(null); };
  ...
  var showLogoOrDoodle = function(fromCache) {
    if (targetDoodle.metadata !== null) {
      ...
      if (targetDoodle.metadata.type === LOGO_TYPE.INTERACTIVE) {
        ...
        var eventType =
            isCta ? (fromCache ? LOG_TYPE.NTP_CTA_LOGO_SHOWN_FROM_CACHE
  ...
  var applyDoodleMetadata = function() {
      ...
      logoDoodleButton.onclick = function(e) {
        ...
        if (targetDoodle.metadata.logUrl) {
          logoDoodleImage.onload = function() {
            logDoodleImpression(targetDoodle.metadata.logUrl,
                                /*isAnimated=*/ true);
          };
        }
        logoDoodleImage.src = targetDoodle.metadata.animatedUrl;
    ...
    case LOGO_TYPE.INTERACTIVE:
      ...
      document.body.style.setProperty('--logo-iframe-initial-height',
                                      targetDoodle.metadata.iframeHeightPx +
                                          'px');
      break;
    }
  };
...
!function(a, b) {
  ...
  : "object" == typeof exports &&exports    ? module.exports = b()
                                            : a.Gridifier = b()
}(this, function() {
  var a = function(a, b) {
    var c =
      ...
      for (var c in b)
        ...
        d =
          ...
          for (var c in b)
            !function(
                a,
                c) { Wa[a] = function() { return b[a].apply(c, arguments) } }(c,
                                                                              a)
        },
        e = function(a) { throw new Error(G.ERR + a) },
        f = function() { return function() {} },
        g = function(
            a, b) { return function() { return b[a].apply(b, arguments) } },
        h = f(), i = f(),
        j =
            function() {
          return {
            isScheduled: function() { return !1 }
          }
        },
        k = f(), l = f(), m = f(), n = f(), o = f(), p = f(), q = (f(), f()),
        r = f(), s = f(), t = f(), u = f(), v = f(), w = f(), x = f(), y = f(),
        z = f(),
        A =
            function() {
          return { getCoordsChanger: f() }
        },
        B = f(), C = f(), D = f(), E = f(), F = f(), G = {
          DATA : "data-gridifier",
        ...
        M = {SHOW : 0, HIDE : 1, RENDER : 2, DEL_RENDER : 3}, N = {
          FILTER : "filter",
          SORT : "sort",
          TOGGLE : "toggle",
          DRAG : "drag",
        ...
        R = function() {
          for (var a = function() { return function(a) { return a } },
                   b =
                       function() {
                         return function(a) { return Math.round(a) }
                       },
                   c =
                       function() {
    ...
    n = function() {
      return function(a, b, c, d, e, f, g, h, i) {
        var i = i || !1;
        i || (b != a.style.left && f.css.set(a, {left : b}),
      ...
      return function(a, b, c, d, e, f, g, h, i) {
        ...
        var i = i || !1;
        return i ? void f.css3.transform(a, "scale3d(1,1,1)")
                 : (b != a.style.left &&
      ...
      return function(g, h, i, j, k, l, m, n, o) {
        ...
        if (o)
          return c(g, h, i, l),
                 void l.css3.transform(g, "scale3d(1,1,1) " + e + f);
        var h = parseFloat(h), i = parseFloat(i), p = parseFloat(g.style.left),
        ...
        if (null == v || "undefined" == typeof v[1] || null == v[1])
          ...
          var x = v[1].split(","), y = x[0].gridifierTrim(),
              z = x[1].gridifierTrim();
          if (y == s + "px" && z == t + "px")
            var w = !1;
          else
        ...
        if (w) {
          l.css3.transitionProperty(g, m.getForCss("transform", g) + " " + j +
                                           "ms " + k),
              s = a(s), t = b(t),
              d && (l.css3.perspective(g, "1000"),
                    l.css3.backfaceVisibility(g, "hidden"));
          var A = d ? ",0px" : "";
          l.css3.transformProperty(g, e, s + "px," + t + "px" + A)
        }
      }
    }, A = function() { this._selectToggler = null }, c(A, {
      getCoordsChanger : function() {
        return function(a, b, c, d) {
          var b = parseFloat(b), c = parseFloat(c);
          if (!d.hasTransitions())
            return void d.css.set(a, {left : b + "px", top : c + "px"});
          var e = parseFloat(a.style.left), f = parseFloat(a.style.top),
              g = function(
                  a, b) { return a > b   ? a - b
                                 : b > a ? -1 * (b - a)
                                         : 0 },
              h = g(b, e), i = g(c, f);
          d.css3.transitionProperty(a, "none"), d.css3.perspective(a, "1000"),
              d.css3.backfaceVisibility(a, "hidden"),
              d.css3.transformProperty(a, "translate3d",
                                       h + "px," + i + "px,0px")
        }
      },
      ...
      getSelectToggler : function() {
        return null != this._selectToggler
                   ...
                   : (this._selectToggler = {
                       ...
                       _props : [
                         "webkitTouchCallout", "webkit", "khtml", "moz", "ms",
                         "userSelect"
                       ],
                       _origProps : {},
                       _hasProp : function(a) {
    ...
    var S = function() {
      this._settings = {
        ...
        heightPxAs : 0,
        repackSize : null,
        filter : {selected : "all", all : function(a) { return !0 }},
        sort : {
          selected : "default",
        ...
        drag : {
          selected : "cloneCss",
          cloneCss : function(a, b, c) { c.copyComputedStyle(b, a) }
        },
        rsort : {selected : "default", "default" : function(a) { return a }},
    ...
    c(S, {
      ...
      _adjustCoreSettings : function(a) {
        this.eq("grid", "horizontal") && !Y.hasOwnProp(a, "align") &&
            this.set("align", "left"),
            Y.hasOwnProp(a, "align") && this.set("intersections", !1),
            this.eq("dragifierMode", "d") &&
                (this.set("intersections", !0), this.set("sortDispersion", !0),
      ...
      _parseApiSetting : function(a, b) {
        if ("string" == typeof b || b instanceof String ||
          ...
          this._settings[a].userfn = b, this._settings[a].selected = "userfn";
      ...
      get : function(a) { return this._check(a, "get"), this._settings[a] },
      set : function(a, b) {
        if (!Y.isArray(a))
          return this._check(a, "set"),
                 this._settings[a] = b,
                 void $a.emitInternal(Q.SET_SETTING_FOR_NZER, a);
        for (var c = 0; c < a.length; c++)
          this.set(a[c][0], a[c][1])
      },
      getApi : function(a) {
        this._check(a, "getApi");
        var b = this.get(a),
            c = function(
                b) { e("getApi('" + a + "') -> " + b + " fn not found") };
        if (a != N.FILTER)
      ...
      addApi : function(a, b,
                        c) { this._check(a, "addApi"), this.get(a)[b] = c },
      eq : function(a,
                    b) { return this._check(a, "eq"), this._settings[a] == b },
      notEq : function(a, b) { return !this.eq(a, b) },
      _check : function(a, b) {
    ...
    var T = function() {
      ...
      var a = this;
      $a.onRsortChange(function() { a._update.call(a) }), this._update()
    };
    c(T, {
      _update : function() {
        var a = this, b = _a.get("rsort").selected;
        "default" == b || this._created || (this._created = !0, new i(_a)),
            a._change(b)
      },
      _change : function(a) {
        var b = this;
        "default" == a ? $a.onBeforeShowForRsort(null)
                       : $a.onBeforeShowForRsort(function() {
                           clearTimeout(b._repositionTimeout),
                               b._repositionTimeout =
                                   setTimeout(function() { b._reposition() },
                                              H.RESORT_REPOS_DELAY)
                         })
      },
      _reposition : function() {
        if (null == _a.get("repackSize"))
          return void Jb.all();
        var a = _a.get("repackSize"), b = Wa.all();
        return b.length < a ? void Jb.all()
                            : void Jb.fromFirstSortedCn([ b[b.length - a] ])
      }
    }),
        i = function(a) { this._createBySizesRsorts(a) }, c(i, {
          _createBySizesRsorts : function(a) {
            var b = 1e5, c = g("addApi", a), d = function(a) {
              ...
              if (c)
                ...
                var d = e(a);
                d.sort(function(
                    a, b) { return parseFloat(b.area) - parseFloat(a.area) })
              }
              for (var g = [], h = !1; !h;) {
            ...
            for (var p = [ 1, 2, 3, 4 ], o = 5; 50 >= o; o += 5)
              p.push(o);
            ...
            c("rsort", "areaDesc", s(!1)), c("rsort", "areaAsc", s(!0)),
        ...
        h =
          ...
          var b = {
            byOriginalPos : function(a, b) {
              return Y["int"](Y.get(a, H.COLL.SORT_INDEX_DATA)) -
            ...
            byMultipleComparators : function(a, b, c) {
              for (var d = 0; d < c.length; d++) {
                var e = this.byComparator(c[d].forFirst, c[d].forSecond,
                                          c[d].reverseOrder);
                {
                  if (0 != e)
                    return e;
                  if (d == c.length - 1)
                    return this.byOriginalPos(a, b)
                }
              }
            },
            buildComparators : function(a, b, c, d, f, g) {
              if ("undefined" == typeof d && e("No sort comp param."),
                  Y.isArray(d))
            ...
            sortBy : function(a, b, c, d, e, f) {
              return this.byMultipleComparators(
                  a, b, this.buildComparators(a, b, c, d, f || !1, e || !1))
            }
          },
              c = {
                Data : function(a, b) { return Y.get(a, b) },
                Content : function(a) { return a.innerHTML },
                Query : function(a,
                                 b) { return Y.find.byQuery(a, b)[0].innerHTML }
              },
              d = function(a, b,
                           c) { return c(b ? this._applyReplacers(a, b) : a) },
              f = {
                Def : function(a) { return a },
                Int : function(a) { return Y["int"](a) },
                Float : function(a) { return parseFloat(a) }
              },
              g = function(b, c) {
                return function(e, f, g) { return d.call(a, b(e, f), g, c) }
              }, h = function(a, b) {
                return b ? function(
                               b, c, d,
                               e) { return this.sortBy(b, c, a, null, d, e) }
                         : function(b, c, d, e,
                                    f) { return this.sortBy(b, c, a, d, e, f) }
              }, i = {};
          for (var j in c)
            for (var k in f) {
              var l = "by" + j + ("Def" == k ? "" : k);
        ...
        w = function(
            a) { this._settings = a, this._rotate = new x, this.create() },
        c(w, {
          create : function() {
            for (var a = [ "", "WithFade", "WithFadeOut" ],
        ...
        r =
          ...
          return a ? new s(b("0", !1), b("1", !0), b("0", !0), b("1", !1))
                   : new s(f(), f(), f(), f())
        },
        u = function(
            a) { this._create(a), this._createPairs(a), this._createCustom(a) },
        c(u, {
          _create : function(a) {
            var b =
                    [
                ...
                d = function(b, d) {
                  for (var e = new v, f = "toggle", g = 0; 5 >= g; g++) {
                    var h = c[g];
                    a.addApi(f, "slide" + b[g],
                             e.create(!1, h[0], h[1], h[2], d))
                  }
                  for (var g = 0; 5 >= g; g++) {
                    var h = c[g];
                    a.addApi(f, "slide" + b[g + 6],
            ...
            for (var b = new v,
                     c =
                         [
                           ...
                           [
                             "LeftBottomThenRightBottom", "LeftBottom",
                             "RightBottom"
                           ],
                           [
                             "TopRightThenBottomRight", "TopRight",
                             "BottomRight"
                           ]
                         ],
                     d = 0;
                 d < c.length; d++) {
              var e = "slide", f = "WithFade";
              a.addApi("toggle", e + c[d][0], b.createCycled([
                a.get("toggle")[e + c[d][1]], a.get("toggle")[e + c[d][2]]
              ])),
                  a.addApi("toggle", e + c[d][0] + f, b.createCycled([
          ...
          _createCustom : function(a) {
            for (var b = new v, c = "slide", d = "WithFade",
                     e =
                         [
                           [
                             "ClockwiseFromCenters", "Left", "Top", "Right",
                             "Bottom"
                           ],
                           [
                             "ClockwiseFromSides", "Left", "Top", "Right",
                             "Bottom"
                           ],
                           [
                             "ClockwiseFromCorners", "LeftTop", "RightTop",
                             "RightBottom", "LeftBottom"
                           ]
                         ],
                     f = 0;
                 f < e.length; f++)
              a.addApi("toggle", c + e[f][0], b.createCycled([
                a.get("toggle")[c + e[f][1]], a.get("toggle")[c + e[f][2]],
                a.get("toggle")[c + e[f][3]], a.get("toggle")[c + e[f][4]]
              ])),
                  a.addApi("toggle", c + e[f][0] + d, b.createCycled([
    ...
    c(U, {
      ...
      updateTransformOrigin : function(a, b, c, d, e, f) {
        var g = parseFloat(b), h = parseFloat(c), i = parseFloat(a.style.left),
      ...
      resetTransformOrigin : function(
          a, b) { b.css3.transformOrigin(a, "50% 50%") }
    });
    var V = function() { this._syncTimeouts = {}, this._nextSyncId = 0 };
    c(V, {
      markAsSynced : function(
          a) { Y.set(a, I.SYNCER_DATA, ++this._nextSyncId) },
      isSynced : function(a) { return Y.has(a, I.SYNCER_DATA) },
      ...
      flush : function(a) {
          ...
          return {
            show: function(a, b, c, d, e, f, g, h, i) {
              ...
              h.css3.transition(a, j + " " + d + "ms " + e),
                  h.set(a, i.TOGGLE.IS_ACTIVE, "y"), h.css3.opacity(a, "0"),
                  g.add(a, setTimeout(function() {
                          h.rm(a, i.TOGGLE.IS_ACTIVE), h.hide(a),
                              h.css3.transition(a, "none"),
                              h.css3.opacity(a, "1"), h.css3.transition(a, ""),
                              f.emit(i.EVENT.HIDE, a)
                        }, d + 20))
            }
          }
        },
        x = function() { this._fadeType = null, this._nextRotateGUID = 0 },
        c(x, {
          setParams : function(a, b, c, d, e, f, g) {
            this._time = a, this._timing = b, this._ev = c, this._sync = d,
            this._dom = e, this._api = f, this._cn = g
          },
          setFadeType : function(a) { this._fadeType = a },
          show3d : function(a, b) { this._rotate(a, "rotate3d", b, !1) },
          hide3d : function(a, b) { this._rotate(a, "rotate3d", b, !0) },
          show : function(a, b) { this._rotate(a, b, "", !1) },
          hide : function(a, b) { this._rotate(a, b, "", !0) },
          _rotate : function(a, b, c, d) {
            var e = this._dom, f = this._api, g = this._ev, h = this._cn.x1,
                i = this._cn.y1, j = !d;
            if (e.has(a, f.ROTATE.GUID_DATA)) {
              var k = !1, l = e.get(a, f.ROTATE.GUID_DATA),
                  m = e.find.byClass(f.grid,
                                     f.ROTATE.SCENE_CLASS_PREFIX + l)[0],
                  n = m.childNodes[0], o = n.childNodes[0], p = n.childNodes[1],
                  q = p.childNodes[0], r = f.getS("coordsChangeTime"),
                  s = f.getS("coordsChangeTiming");
              f.cc(m, h, i, r, s, e, f.prefix, f.getS)
            } else {
              var k = !0;
              e.set(a, f.ROTATE.GUID_DATA, ++this._nextRotateGUID);
              var m = this._createScene(a, h, i), n = this._createFrames(m),
                  q = this._createClone(a);
              e.css.addClass(m, f.ROTATE.SCENE_CLASS_PREFIX +
                                    this._nextRotateGUID),
            ...
            e.css3.transitionProperty(o, t + " " + this._time + "ms " +
                                             this._timing),
                e.css3.transitionProperty(p, u + " " + this._time + "ms " +
                                                 this._timing),
                this._sync.add(
                    a, setTimeout(
                           function() {
                             var a = f.getS("rotateAngles"), d = a[j ? 2 : 0],
                                 g = a[j ? 3 : 1];
                ...
                this._sync.add(a, setTimeout(function() {
                                 m.parentNode.removeChild(m),
                                     ...
                                     j ? (e.show(a), g.emit(f.EVENT.SHOW, a))
                                       : (e.hide(a), g.emit(f.EVENT.HIDE, a))
                               }, this._time + 40))
          },
          _createScene : function(a, b, c) {
            var d = this._api, e = this._dom, f = e.div(),
            ...
            return d.cc(f, b, c, h, i, e, d.prefix, d.getS, !0),
                   d.cc(f, b, c, h, i, e, d.prefix, d.getS), f
          },
          _createFrames : function(a) {
            var b = this._dom, c = b.div();
            return b.css.set(c, {
              width : "100%",
              height : "100%",
              position : "absolute"
          ...
          _createClone : function(a) {
            var b = this._dom, c = this._api, d = a.cloneNode(!0);
            c.collect.markAsNotCollectable(d);
            var e = c.sr.getUncomputedCSS(a), f = b["int"](e.height);
            return b.css.set(d, {
              left : "0px",
              top : "0px",
              visibility : "visible",
              ...
              height : c.srManager.outerHeight(a) + "px"
                   ...
                   b.css.set4(d, "margin", 0), b.css3.transition(d, ""),
                   b.css3.transform(d, ""),
                   0 == f && b.css.set4(d, "padding", 0), d
          },
          _createFrame : function(a, b, c, d, e, f) {
            var g = this._dom, h = this._api, i = g.div();
            g.css.set(i, {
              display : "xblock",
              position : "absolute",
              width : "100%",
              ...
              zIndex : f
                ...
                h.getS("rotateBackface") ||
                    g.css3.backfaceVisibility(i, "hidden"),
                b.appendChild(i);
          ...
          _initFade : function(a, b, c) {
            var d = this._dom, e = this._api, f = this._time, g = this._timing,
                h = e.prefix.getForCss("opacity", a), i = function() {
                  return d.css3.transition(a, "none"),
                         d.css3.opacity(a, b ? 0 : 1), b ? 1 : 0
                };
            if (this._fadeType != e.ROTATE.FADES.NONE)
              if (this._fadeType == e.ROTATE.FADES.FULL) {
                ...
                if (d.css3.transition(a, h + " " + f / 2 + "ms " + g), b)
                  return;
                this._sync.add(
                    c, setTimeout(function() { d.css3.opacity(a, 0) }, f / 2))
              }
          },
            ...
            show: function(c, d, e, f, g, h, i, j, k, l) {
              ...
              if (k.toggle.hasTranslateTransform(c, k.prefix)) {
                ...
                k.toggle.updateTransformOrigin(
                    c, l.x1, l.y1, m.outerWidth(c, !0), m.outerHeight(c, !0), j)
              }
              j.has(c, k.TOGGLE.IS_ACTIVE) ||
                  (j.css3.transition(c, "none"), a(c, f, g, j, k),
                  ...
                  i.add(c, setTimeout(function() {
                          ...
                          j.show(c),
                              ...
                              b(c, f, g, j, k)
                        }, 40)), i.add(c, setTimeout(function() {
              ...
              if (k.toggle.hasTranslateTransform(a, k.prefix)) {
                var m = k.srManager;
                k.toggle.updateTransformOrigin(
                    a, l.x1, l.y1, m.outerWidth(a, !0), m.outerHeight(a, !0), j)
              }
              ...
              0 > o && (o = 0),
                  i.add(a, setTimeout(function() { j.hide(a) }, o)),
                  i.add(a, setTimeout(function() {
                          j.hide(a), j.css3.transition(a, "none"),
                              j.css3.transformProperty(a, "scale3d", "1,1,1"),
                              d(a, f, g, j, k), j.css3.transition(a, ""),
        ...
        v = function() {}, c(v, {
          create : function(a, b, c, d, e) {
            var e = e || !1, a = a || !1;
            if (a)
              var f = "Height", g = "Width", h = "left";
            else
              var f = "Width", g = "Height", h = "top";
            var b = b || !1, c = c || !1, i = !d, j = d, k = function(a, b) {
              if (i)
                return -1 * b.srManager["outer" + f](a, !0);
              if (j) {
            ...
            return {
              show: function(a, b, c, d, f, g, h, i, j, k) {
                ...
                h.add(a, setTimeout(
                             function() {
                               i.set(a, j.TOGGLE.IS_ACTIVE_WITH_CC, "y"),
                                   i.has(a, j.TOGGLE.IS_ACTIVE) ||
                                       (e && (i.css3.transition(a, "none"),
                                              i.css3.opacity(a, 0),
                                              i.css3.transition(a, "")),
                                        j.cc(a, l.x, l.y, 0, f, i, j.prefix,
                                             j.getS),
                    ...
                    h.add(a, setTimeout(function() {
                            if (i.show(a), e) {
                              ...
                              i.css3.transitionProperty(a, b + " " + d + "ms " +
                                                               f),
                                  i.css3.opacity(a, 1)
                            }
                            j.cc(a, k.x1, k.y1, d, f, i, j.prefix, j.getS)
                          }, 40)), h.add(a, setTimeout(function() {
                ...
                var l = m(a, j);
                if (i.set(a, j.TOGGLE.IS_ACTIVE, "y"),
                    i.set(a, j.TOGGLE.IS_ACTIVE_WITH_CC, "y"), e) {
                  var n = j.prefix.getForCss("opacity", a);
                  i.css3.transition(a, n + " " + d + "ms " + f),
                      i.css3.opacity(a, 0)
                }
                j.cc(a, l.x, l.y, d, f, i, j.prefix, j.getS),
                    h.add(a, setTimeout(function() { i.hide(a) }, d)),
                    h.add(a, setTimeout(function() {
                            if (e) {
                              var b = j.prefix.getForCss("opacity", a);
                            ...
                            i.rm(a, j.TOGGLE.IS_ACTIVE_WITH_CC), i.hide(a),
                                i.rm(a, j.TOGGLE.IS_ACTIVE),
        ...
        q = function() {
          return {
            show: function(
                a, b, c, d, e, f, g, h,
                i) { g.flush(a), h.show(a), f.emit(i.EVENT.SHOW, a) },
                hide: function(
                    a, b, c, d, e, f, g, h,
                    i) { g.flush(a), h.hide(a), f.emit(i.EVENT.HIDE, a) }
          }
        };
    var W =
            function() {
      function a(a) {
        if (a = a || window.event, a.isFixed)
          return a;
        if (a.isFixed = !0,
            a.preventDefault =
                a.preventDefault || function() { this.returnValue = !1 },
            a.stopPropagation =
                a.stopPropagation || function() { this.cancelBubble = !0 },
          ...
          a.pageX = a.clientX + (b && b.scrollLeft || c && c.scrollLeft || 0) -
                    (b.clientLeft || 0),
          a.pageY = a.clientY + (b && b.scrollTop || c && c.scrollTop || 0) -
                    (b.clientTop || 0)
        }
        return !a.which && a.button &&
                   (a.which = 1 & a.button   ? 1
                              : 2 & a.button ? 3
                              : 4 & a.button ? 2
                                             : 0),
               a
      ...
      function b(b) {
        ...
        for (var e in d) {
          ...
          if (f === !1 ? (b.preventDefault(), b.stopPropagation())
                       : void 0 !== f && (b.result = f),
              b.stopNow)
            break
        }
      }
      var c = "gridifierEvents", d = "gridifierHandle", e = function() {
      ...
      return {
        ...
        X = {
          ...
          _getter : function(a, b, c) {
            ...
            if ("string" == typeof d[a])
              return a;
            for (var e = a, a = a.charAt(0).toUpperCase() + a.slice(1), f = 0;
                 f < this._prefixes.length; f++) {
          ...
          get : function(
              a, b) { return this._getter(a, b, function(a) { return a }) },
        ...
        Y = {
          init : function() {
            this._createTrimFunction(), this._createHasOwnPropFn(),
                this._checkIfHasTransitions(Y.div()), this.browsers.init(),
                this.css3.init()
          },
          _createTrimFunction : function() {
            "function" != typeof String.prototype.gridifierTrim &&
                (String.prototype.gridifierTrim =
                     function() { return this.replace(/^\s+|\s+$/g, "") })
          },
          _createHasOwnPropFn : function() {
            var a = Y.div(), b = document.body || document.documentElement;
            b.appendChild(a),
          ...
          _checkIfHasTransitions : function(a) {
            var b = [
              ...
              "msTransition", "MsTransition", "transition"
            ];
            this._hasTransitions = !1;
            for (var c = 0; c < b.length; c++)
              void 0 !== a.style[b[c]] && (this._hasTransitions = !0)
          },
          get : function(a, b) { return a.getAttribute(b) },
          set : function(a, b, c) {
            if (this.isArray(b))
          ...
          rm : function(a, b) { a.removeAttribute(b) },
          rmIfHas : function(a, b) {
            if (this.isArray(b))
              for (var c in b)
                this.has(a, b[c]) && this.rm(a, b[c]);
            else
              this.has(a, b) && this.rm(a, b)
          },
          has : function(a, b) {
            return null === a.getAttribute(b) || "" === a.getAttribute(b) ? !1
                                                                          : !0
          },
          "int" : function(a) { return parseInt(a, 10) },
          isJquery : function(a) {
            return "undefined" == typeof jQuery ? !1 : a && a instanceof jQuery
          },
          isNative : function(a) {
            return "undefined" != typeof a && "undefined" != typeof a.tagName &&
          ...
          isObj : function(a) { return "object" == typeof a && null !== a },
          ...
          hasTransitions : function() { return this._hasTransitions },
          hasVal : function(a, b) {
            for (var c in a)
              if (a[c] == b)
                return !0;
          ...
          hasOwnProp : function(a, b) { return this._hasOwnPropFn(a, b) },
          hasAnyProp : function(a, b) {
            for (var c = 0; c < b.length; c++)
              if (this._hasOwnPropFn(a, b[c]))
                return !0;
            return !1
          },
          ...
          show : function(a) { a.style.visibility = "visible" },
          hide : function(a) { a.style.visibility = "hidden" },
          ...
          browsers : {
            ...
            isAndroid : function() { return /android/i.test(this._navigator); },
          ...
          css : {
            ...
            set4 : function(a, b, c) {
              for (var d = [ "Left", "Right", "Top", "Bottom" ], e = 0;
                   e < d.length; e++)
            ...
            hasClass : function(a, b) {
              ...
              c = c.split(" ");
              for (var d = 0; d < c.length; d++)
                if (c[d] = c[d].gridifierTrim(), c[d] == b)
                  return !0;
              return !1
            },
            ...
            removeClass : function(a, b) {
              for (var c = a.getAttribute("class").split(" "), d = "", e = 0;
                   e < c.length; e++)
          ...
          css3 : {
            ...
            transform : function(a, b) { a.style[X.get("transform", a)] = b },
            transformProperty : function(a, b, c) {
              var d = a.style[X.get("transform", a)];
              if (0 == d.length)
                return void (a.style[X.get("transform", a)] =
                                 b + "(" + c + ")");
              for (var e = "", f = d.split(/\)/), g = !1, h = 0; h < f.length;
                   h++) {
                var i = f[h].gridifierTrim();
                0 != i.length &&
                    (-1 !== i.search(b) ? (e += " " + b + "(" + c + ")", g = !0)
                                        : e += " " + i + ")")
              }
              g || (e += " " + b + "(" + c + ")"),
            ...
            opacity : function(a, b) { this.style(a, this._opacityProps, b) },
            perspective : function(
                a, b) { this.style(a, this._perspectiveProps, b) },
            transformStyle : function(
                a, b) { this.style(a, this._transformStyleProps, b) },
            backfaceVisibility : function(
                a, b) { this.style(a, this._backfaceVisibilityProps, b) },
          ...
          find : {
            ...
            byClass : function(a, b) { return a.querySelectorAll("." + b) },
            byQuery : function(a, b) {
              var c = b.gridifierTrim()[0];
              if (">" == c) {
                for (var d = b.substr(2, b.length - 1),
                         e = a.querySelectorAll(d), f = [], g = 0;
                     g < e.length; g++)
        ...
        Z = {
          ...
          recalcPtWidthFn : function(a, b, c,
                                     d) { return this.outerWidth(a, b, c, d) },
          recalcPtHeightFn : function(
              a, b, c, d) { return this.outerHeight(a, b, c, d) },
          _lastRawWidth : null,
          _lastRawHeight : null,
          ...
          init : function() {
            ...
            this._findPrefixedProps(), this._findBorderBoxType(Y.div()),
            this._findPtValsCalcType(Y.div(), Y.div())
          },
          clearRecursiveSubcallsData : function() {
            this._lastRawWidth = null, this._lastRawHeight = null,
            this._lastBorderWidth = null, this._lastBorderHeight = null,
          ...
          getUncomputedCSS : function(a) {
            var b = a.parentNode.cloneNode(), c = a.cloneNode();
            b.appendChild(c), b.style.display = "none";
            var d = "HTML" == a.parentNode.nodeName ? a.parentNode
                                                    : a.parentNode.parentNode;
            d.appendChild(b);
            for (var e = this.getComputedCSS(c), f = {},
                     g =
                         [
                           "paddingLeft", "paddingRight", "paddingTop",
                           "paddingBottom", "marginLeft", "marginRight",
                           "marginTop", "marginBottom", "width", "height"
                         ],
                     h = 0;
                 h < g.length; h++)
              f[g[h]] = e[g[h]];
          ...
          _ensureHasComputedProp : function(a,
                                            b) { b in a || e("no prop " + b) },
          _hasPtCSSVal : function(a, b, c) {
            var d = function(a, b, c) {
              this._ensureHasParentNode(b), c = c || this.getUncomputedCSS(b),
          ...
          _getPtCSSVal : function(a, b, c) {
            return this._ensureHasParentNode(b),
                   c = c || this.getUncomputedCSS(b),
                   this._ensureHasComputedProp(c, a), c[a]
          },
          ...
          _recalcTwoSidePropPtVals : function(a, b, c, d, e, f) {
            var g = e + (f ? "Top" : "Left"), h = e + (f ? "Bottom" : "Right"),
                i = c[g], j = c[h];
            return this._hasPtCSSVal(g, a, d) &&
                       (i = this._recalcPtVal(a, b, d, g)),
                   this._hasPtCSSVal(h, a, d) &&
                       (j = this._recalcPtVal(a, b, d, h)),
                   i + j
          },
          ...
          _cascadedToComputed : function(a, b, c) {
            ...
            if (!d.test(b))
              return b;
            var e = a.style, f = a.runtimeStyle, g = e.left, h = f && f.left;
            return h && (f.left = c.left), e.left = b, b = e.pixelLeft,
                                           e.left = g, h && (f.left = h), b
          },
          ...
          _getComputedProps : function(a, b, c) {
            for (var d = {}, e = 0; e < this._getProps[a].length; e++) {
              var f = this._getProps[a][e], g = b[f];
              this._isCascadedCSSVal(g) &&
                  (g = this._cascadedToComputed(c, g, b)),
                  g = parseFloat(g), g = isNaN(g) ? 0 : g, d[f] = g
            }
            return d
          },
          ...
          cloneComputedStyle : function(a, b) {
            var c = function(a) {
              return a.replace(
                  /-+(.)?/g, function(a, b) { return b ? b.toUpperCase() : "" })
          ...
          _reclone : function(a, b) {
            for (var c = [ "font", "fontSize", "fontWeight", "lineHeight" ],
                     d = [ "Width", "Color", "Style" ],
                     e = [ "Left", "Right", "Top", "Bottom" ], f = 0;
                 f < d.length; f++)
              for (var g = 0; g < e.length; g++)
                c.push("border" + e[g] + d[f]);
            for (var f = 0; f < c.length; f++) {
              var h = c[f];
              "undefined" != typeof a[h] && b.style[h] != a[h] &&
                  (b.style[h] = a[h])
            }
          }
        };
    Z._getComputedCSSFn = function() {
      return window.getComputedStyle
                 ? function(a) { return window.getComputedStyle(a, null) }
      ...
      d.appendChild(a), Y.css.set(b, {width : "10%", height : "200px"}),
          a.appendChild(b);
      var e = 117.796875.toFixed(1),
          f = parseFloat(this.outerWidth(b, !0, !0)).toFixed(1);
      this._ptValsCalcType =
          e == f ? this._ptValsCalcTypes.BROWSER : this._ptValsCalcTypes.RECALC,
      d.removeChild(a)
    }, Z.outerWidth = function(a, b, c, d) {
      var b = b || !1, c = c || !1, d = d || !1, e = this.getComputedCSS(a);
      if (c || this._areBrowserPtVals())
        var f = !1;
      ...
      var g = this._getComputedProps("forOw", e, a),
          h = g.paddingLeft + g.paddingRight, i = g.marginLeft + g.marginRight,
          j = g.borderLeftWidth + g.borderRightWidth, k = 0,
          l = this._normalizeComputedCSS(e.width);
      l !== !1 && (k = l);
      var m = null, n = null;
      return f && (m = this.getUncomputedCSS(a),
                   n = this.recalcPtWidthFn.call(
                       this, a.parentNode, !1, "HTML" == a.parentNode.nodeName,
                       !0),
                   this._hasLastBorderBox && this._hasPtCSSVal("width", a, m) &&
                       (n -= this._lastBorderWidth)),
             f && this._hasPtCSSVal([ "paddingLeft", "paddingRight" ], a, m) &&
                 (h = this._recalcTwoSidePropPtVals(a, n, g, m, "padding")),
             f && this._hasPtCSSVal("width", a, m) &&
                 (k = this._recalcPtVal(a, n, m, "width")),
             !this._isDefBoxSizing(e) ||
                     this._isDefBoxSizing(e) && !this._isOuterBoxSizing()
                 ? (this._lastRawWidth = k, k += h, d || (k += j),
                    this._hasLastBorderBox = !1)
                 : (this._hasLastBorderBox = !0, this._lastRawWidth = k,
                    this._lastBorderWidth = j),
             b &&
                 (f &&
                      this._hasPtCSSVal([ "marginLeft", "marginRight" ], a,
                                        m) &&
      ...
      var g = this._getComputedProps("forOh", e, a),
          h = g.paddingTop + g.paddingBottom, i = g.marginTop + g.marginBottom,
          j = g.borderTopWidth + g.borderBottomWidth, k = 0,
          l = this._normalizeComputedCSS(e.height);
      l !== !1 && (k = l);
      var m = null, n = null, o = null;
      return f &&
                 (m = this.getUncomputedCSS(a),
                  n = this.recalcPtWidthFn.call(this, a.parentNode, !1,
                  ...
                  o = this.recalcPtHeightFn.call(
                      this, a.parentNode, !1, "HTML" == a.parentNode.nodeName,
                      !0),
                  this._hasLastBorderBox && this._hasPtCSSVal("height", a, m) &&
                      (o -= this._lastBorderHeight)),
             f && this._hasPtCSSVal([ "paddingTop", "paddingBottom" ], a, m) &&
                 (h = this._recalcTwoSidePropPtVals(a, n, g, m, "padding", !0)),
             f && this._hasPtCSSVal("height", a, m) &&
                 (k = this._recalcPtVal(a, o, m, "height")),
             !this._isDefBoxSizing(e) ||
                     this._isDefBoxSizing(e) && !this._isOuterBoxSizing()
                 ? (this._lastRawHeight = k, k += h, d || (k += j),
                    this._hasLastBorderBox = !1)
                 : (this._hasLastBorderBox = !0, this._lastRawHeight = k,
                    this._lastBorderHeight = j),
             b && (f &&
                       this._hasPtCSSVal([ "marginTop", "marginBottom" ], a,
                                         m) &&
                       (i = this._recalcTwoSidePropPtVals(a, n, g, m, "margin",
                                                          !0)),
                   k += i),
    ...
    c($, {
      ...
      create : function(a, b) {
        ...
        return b.item = a, b.itemGUID = db.get(a),
               b.hOffset = Y.hasOwnProp(b, "hOffset") ? b.hOffset : 0,
               b.vOffset = Y.hasOwnProp(b, "vOffset") ? b.vOffset : 0,
               b.restrictCollect =
                   Y.hasOwnProp(b, "restrictCollect") ? b.restrictCollect : !1,
               Ya.isConnected(a) || Ya.markAsConnected(a), b
      },
      rm : function(a, b) {
        for (var c = 0; c < a.length; c++)
          if (db.get(b.item) == db.get(a[c].item))
            return void a.splice(c, 1)
      },
      ...
      remapGUIDSIn : function(a) { this._remapGUIDS(a) },
      ...
      getMinWidth :
          function() { return this._getMinSize("x1", "x2", Za.x2(), "Width") },
      getMinHeight :
          function() { return this._getMinSize("y1", "y2", Za.y2(), "Height") },
      _compareGUIDS : function(a, b, c) {
        for (var d = db.get(b), e = 0; e < a.length; e++)
          if (c(db.get(a[e].item), d))
            return !0;
        return !1
      },
      isAnyGUIDSmallerThan : function(a, b) {
        return this._compareGUIDS(a, b, function(a, b) { return b > a })
      },
      isAnyGUIDBiggerThan : function(a, b) {
        return this._compareGUIDS(a, b, function(a, b) { return a > b })
      },
      getMaxY : function() {
      ...
      restoreOnSortDispersion : function(a, b, c) {
        var d = vb.sortForReappend(rb.get()), e = d[d.length - 1],
            f = function(a, b, c) { a.x1 = b, a.x2 = b, a.y1 = c, a.y2 = c };
    ...
    c(_, {
      isIntersectingAny : function(a, b) {
        for (var c = 0; c < a.length; c++) {
          var d = a[c],
              e = b.y1 < d.y1 && b.y2<d.y1, f = b.y1>d.y2 && b.y2 > d.y2,
              g = b.x1 < d.x1 && b.x2<d.x1, h = b.x1>d.x2 && b.x2 > d.x2;
          if (!(e || f || g || h))
            return !0
        }
        return !1
      ...
      getAllWithIntersectedCenter : function(a) {
        for (var b = rb.get(), c = [], d = 0; d < b.length; d++) {
          var e = b[d].x2 - b[d].x1 + 1, f = b[d].y2 - b[d].y1 + 1,
              g = b[d].x1 + e / 2, h = b[d].y1 + f / 2,
      ...
      findAllMaybeIntOnVgAppend : function(a) {
        return this._findAllMaybeIntCns(a, function(a, b) { return a.y > b.y2 })
      },
      findAllMaybeIntOnVgPrepend : function(a) {
        return this._findAllMaybeIntCns(a, function(a, b) { return a.y < b.y1 })
      },
      findAllMaybeIntOnHgAppend : function(a) {
        return this._findAllMaybeIntCns(a, function(a, b) { return a.x > b.x2 })
      },
      findAllMaybeIntOnHgPrepend : function(a) {
        return this._findAllMaybeIntCns(a, function(a, b) { return a.x < b.x1 })
      }
    });
    var aa = function() {
      this._ranges = null,
      _a.eq("grid", "vertical") ? this.init("y1", "y2") : this.init("x1", "x2")
    };
    c(aa, {
      init : function(a, b) {
        var c = {cnIndexes : []};
        c[a] = -1, c[b] = H.RANGE_SIZE - 1, this._ranges = [ c ],
      ...
      attachCn : function(a, b, c, d) {
        ...
        for (var f = !1, g = 0; g < this._ranges.length; g++) {
          var h = a[d]<this._ranges[g][c], i = a[c]>this._ranges[g][d];
      ...
      firstRngIndexFn : function() { return function(a) { return 0 } },
      lastRngIndexFn :
          function() { return function(a) { return a.length - 1 } },
      lowerCrCnIndexesFn : function() {
        return function(a, b) {
          for (var c = [], d = a; d >= 0; d--)
            c.push(b[d].cnIndexes);
          return c
        }
      },
      upperCrCnIndexesFn : function() {
        return function(a, b) {
          for (var c = [], d = a; d < b.length; d++)
            c.push(b[d].cnIndexes);
          return c
        }
      },
      incFn : function() { return function(a) { return ++a } },
      decFn : function() { return function(a) { return --a } },
      getAllCnsFromIntRange : function(a, b, c) {
        for (var d = this._ranges, e = 0; e < d.length; e++)
          if (a >= d[e][b] && a <= d[e][c])
            return d[e].cnIndexes;
      ...
      getAllCnsFromIntAndTLSideRgs : function(a, b, c) {
        for (var d = this._ranges, e = [], f = null, g = d.length - 1; g >= 0;
             g--)
          if (a >= d[g][b] && a <= d[g][c]) {
            f = g;
            break
    ...
    c(ba, {
      _sortForReappend : function(a, b, c, d) {
        if (_a.eq("sortDispersion", !1))
          a.sort(function(
              a, b) { return db.get(a.item) > db.get(b.item) ? 1 : -1 });
        else {
    ...
    var ca = function() { this._lastXYExpandedCns = [] };
    c(ca, {
      _isBefore : function(a, b, c, d) { return a[c] < b[c] && a[d] < b[c] },
      _isAfter : function(a, b, c, d) { return a[c] > b[d] && a[d] > b[d] },
      getLastXYExpandedCns : function() { return this._lastXYExpandedCns },
      isIntMoreThanOneCnXY : function(a, b, c) {
        for (var d = this, e = rb.get(), f = [], g = function(a) {
               if (0 == f.length)
                 return !1;
               for (var g = 0; g < f.length; g++) {
                 var h = e[f[g]], i = h[b], j = h[c];
                 h[b] = Math.ceil(h[b]), h[c] = Math.floor(h[c]);
                 var k = d._isBefore(a, h, b, c), l = d._isAfter(a, h, b, c);
                 if (h[b] = i, h[c] = j, !k && !l)
                   return !0
               }
               return !1
             }, h = 0, i = 0; i < e.length; i++)
          d._isBefore(a, e[i], b, c) || d._isAfter(a, e[i], b, c) || g(e[i]) ||
              (f.push(i), h++);
        return h > 1
      },
        ...
        for (var d = rb.get(), e = null, f = 0; f < d.length; f++)
          if (!this._isBefore(a, d[f], b, c) && !this._isAfter(a, d[f], b, c))
            if (null == e)
              ...
              var g = Math.abs(d[f][c] - d[f][b]), h = Math.abs(e[c] - e[b]);
              g > h && (e = d[f])
            }
        return e
      },
      getAllXYIntCns : function(a, b, c) {
        for (var d = rb.get(), e = [], f = 0; f < d.length; f++)
          this._isBefore(a, d[f], b, c) || this._isAfter(a, d[f], b, c) ||
              e.push(d[f]);
        return e
      },
      expandXYAllCnsToMostBig : function(a, b, c, d, e) {
        var f = g("eq", _a), h = this.getMostBigFromAllXYIntCns(a, b, c);
        if (null != h) {
          for (var i = this.getAllXYIntCns(a, b, c), j = [], k = 0;
               k < i.length; k++)
            if (i[k][b] = h[b], i[k][c] = h[c],
              ...
              if (f("align", "center"))
                ...
                var m = Math.abs(i[k][c] - i[k][b] + 1) - l;
    ...
    var da = function() { this._crs = [], this._nextFlushCb = null };
    c(da, {
      eq : function(a, b) { return a.side == b },
      isInitial : function(a) { return a.itemGUID == K.INITIAL_GUID },
      create : function(a, b, c, d, e) {
        this._crs.push({
          type : a,
          side : b,
      ...
      count : function() { return this._crs.length },
      get : function() { return this._crs },
      set : function(a) { this._crs = a },
      setNextFlushCb : function(a) { this._nextFlushCb = a },
      flush : function() {
        this._crs = [], "function" == typeof this._nextFlushCb &&
                            (this._nextFlushCb(), this._nextFlushCb = null)
      },
      getClone : function() {
        for (var a = [], b = [ "type", "side", "x", "y", "itemGUID" ], c = 0;
             c < this._crs.length; c++) {
    ...
    var ea = function() { this._cleaner = null };
    c(ea, {
      _updateCleaner : function() {
        var a = K.CLEANERS;
        this._cleaner =
            _a.eq("sortDispersion", !1) ? a.INSIDE_OR_BEFORE : a.INSIDE
      },
      ...
      _isMappedCrIntAnyTopCn : function(a) {
        return this._isMappedCrIntAnySideCn(a, "x", "x1", "x2", function(a, b) {
          return this._isInsideCleaner() ? a.y >= b.y1 && a.y <= b.y2
                                         : a.y >= b.y1
        })
      },
      _isMappedCrIntAnyBottomCn : function(a) {
        return this._isMappedCrIntAnySideCn(a, "x", "x1", "x2", function(a, b) {
          return this._isInsideCleaner() ? a.y <= b.y2 && a.y >= b.y1
                                         : a.y <= b.y2
        })
      },
      _isMappedCrIntAnyLeftCn : function(a) {
        return this._isMappedCrIntAnySideCn(a, "y", "y1", "y2", function(a, b) {
          return this._isInsideCleaner() ? a.x >= b.x1 && a.x <= b.x2
                                         : a.x >= b.x1
        })
      },
      _isMappedCrIntAnyRightCn : function(a) {
        return this._isMappedCrIntAnySideCn(a, "y", "y1", "y2", function(a, b) {
          return this._isInsideCleaner() ? a.x <= b.x2 && a.x >= b.x1
                                         : a.x <= b.x2
        })
      },
      _rmIntFrom : function(a, b, c) {
        var d = ib.get(), e = ib.getClone();
        e.sort(function(
            a, d) { return a[b] == d[b]    ? 0
                           : c(a[b], d[b]) ? -1
                                           : 1 }),
        ...
        for (var f = 0; f < d.length; f++)
          d[f].isInt && (d.splice(f, 1), f--)
      },
      rmIntFromTop : function() {
        this._rmIntFrom("Top", "y", function(a, b) { return a.y > b.y })
      },
      rmIntFromBottom : function() {
        this._rmIntFrom("Bottom", "y", function(a, b) { return a.y < b.y })
      },
      rmIntFromLeft : function() {
        this._rmIntFrom("Left", "x", function(a, b) { return a.x > b.x })
      },
      rmIntFromRight : function() {
        this._rmIntFrom("Right", "x", function(a, b) { return a.x < b.x })
      },
      _rmAllTooFar : function(a, b) {
        ...
        if (0 != c.length) {
          ...
          for (var e = 0; e < c.length; e++)
            b(c[e], d, Y["int"](_a.get("insertRange"))) && (c.splice(e, 1), e--)
        }
      },
      _crSmCr : function(a) { return function(b, c) { return b[a] < c[a] } },
      _crBgCr : function(a) { return function(b, c) { return b[a] > c[a] } },
      _crSmValidC : function(
          a, b) { return function(c, d, e) { return c[a] < d[a] + e * b } },
      _crBgValidC : function(
          a, b) { return function(c, d, e) { return c[a] > d[a] + e * b } },
    ...
    c(fa, {
      _mostYClose : function(a, b, c, d, e, f) {
        for (var g = rb.get(), h = null,
                 i = _a.eq("grid", "vertical") ? e(a) : f(a), j = 0;
             j < i.length; j++)
          for (var k = 0; k < i[j].length; k++) {
            var l = g[i[j][k]];
            (a.x >= l.x1 && a.x <= l.x2 || b(a, l)) && c(a, l) &&
                (null == h ? h = l : d(l, h) && (h = l))
          }
        return h
      },
      _crXBgCnX2 : function(a, b) { return a.x > b.x2 },
      _crXSmCnX1 : function(a, b) { return a.x < b.x1 },
      _crYBgCnY2 : function(a, b) { return a.y > b.y2 },
      _crYSmCnY1 : function(a, b) { return a.y < b.y1 },
      _cnX1BgCnX2 : function(a, b) { return a.x1 > b.x2 },
      _cnX1SmCnX1 : function(a, b) { return a.x1 < b.x1 },
      _cnY2BgCnY2 : function(a, b) { return a.y2 > b.y2 },
      _cnY1SmCnY1 : function(a, b) { return a.y1 < b.y1 },
      _intXCns : function(a) { return rb.getAllIntXCns(a) },
      _intXAndUpperCns : function(a) { return rb.getAllIntXAndTopCns(a) },
      _intXAndLowerCns : function(a) { return rb.getAllIntXAndBottomCns(a) },
      _intYAndLeftCns : function(a) { return rb.getAllIntYAndLeftCns(a) },
      _intYAndRightCns : function(a) { return rb.getAllIntYAndRightCns(a) },
      mostBottomFromTopOrTopLeft : function(a) {
        var b = this;
        return this._mostYClose(a, b._crXBgCnX2, b._crYBgCnY2, b._cnY2BgCnY2,
                                b._intXAndUpperCns, b._intYAndLeftCns)
      },
      mostBottomFromTopOrTopRight : function(a) {
        var b = this;
        return this._mostYClose(a, b._crXSmCnX1, b._crYBgCnY2, b._cnY2BgCnY2,
                                b._intXAndUpperCns, b._intYAndRightCns)
      },
      mostTopFromBottomOrBottomLeft : function(a) {
        var b = this;
        return this._mostYClose(a, b._crXBgCnX2, b._crYSmCnY1, b._cnY1SmCnY1,
                                b._intXAndLowerCns, b._intYAndLeftCns)
      },
      mostTopFromBottomOrBottomRight : function(a) {
        var b = this;
        return this._mostYClose(a, b._crXSmCnX1, b._crYSmCnY1, b._cnY1SmCnY1,
                                b._intXAndLowerCns, b._intYAndRightCns)
      },
      _mostXClose : function(a, b, c, d, e) {
        var f = rb.get(), g = null, h = function(d) {
          a.y >= d.y1 && a.y <= d.y2 && b(a, d) &&
              (null == g ? g = d : c(d, g) && (g = d))
        };
        if (_a.eq("grid", "vertical"))
          for (var i = d(a), j = 0; j < i.length; j++)
            h(f[i[j]]);
        else
      ...
      mostLeftFromRight : function(a) {
        var b = this;
        return this._mostXClose(a, b._crXSmCnX1, b._cnX1SmCnX1, b._intXCns,
                                b._intYAndRightCns)
      },
      mostRightFromLeft : function(a) {
        var b = this;
        return this._mostXClose(a, b._crXBgCnX2, b._cnX1BgCnX2, b._intXCns,
                                b._intYAndLeftCns)
      }
    });
    var ga = function() {};
    c(ga, {
      ...
      _recreate : function(a, b, c, d) {
        rb.reinitRanges(), g("recreateCrs", c)(),
            _a.eq("grid", "vertical") ? jb.rmIntFromBottom()
                                      : jb.rmIntFromRight()
      }
    });
    var ha = function() {};
    c(ha, {
      roundCnPerCr : function(a, b) {
        a.origX1 = a.x1, a.origX2 = a.x2, a.origY1 = a.y1, a.origY2 = a.y2;
        var c = function(a) { return ib.eq(b, a) };
      ...
      unroundCnPerCr : function(a, b) {
        a.x1 = a.origX1, a.y1 = a.origY1, a.x2 = a.origX2, a.y2 = a.origY2
      }
    });
    var ia = function() { this._crs = null };
    c(ia, {
      attach : function(a) { this._crs = a },
      getSelected : function() { return this._crs },
      _selectOnlyMostSideCr : function(a, b, c) {
        for (var d = null, e = null, f = this._crs.length; f--;)
          this._crs[f].side == a && (null == d || c(this._crs[f][b], e)) &&
              (d = this._crs[f].itemGUID, e = this._crs[f][b]);
        if (null != d)
          for (var f = this._crs.length; f--;)
            this._crs[f].side == a && this._crs[f].itemGUID != d &&
                this._crs.splice(f, 1)
      },
      _bgCond : function(a, b) { return a > b },
      _smCond : function(a, b) { return b > a },
      selectOnlyMostBottom : function(
          a) { this._selectOnlyMostSideCr(a, "y", this._bgCond) },
      selectOnlyMostTop : function(
          a) { this._selectOnlyMostSideCr(a, "y", this._smCond) },
      selectOnlyMostRight : function(
          a) { this._selectOnlyMostSideCr(a, "x", this._bgCond) },
      selectOnlyMostLeft : function(
          a) { this._selectOnlyMostSideCr(a, "x", this._smCond) },
      _selectOnly : function(a, b) {
        for (var c = 0; c < this._crs.length; c++)
          !ib.isInitial(this._crs[c]) && b(this._crs[c].itemGUID) &&
              a != this._crs[c].side && (this._crs.splice(c, 1), c--)
      },
      selectOnlyFromAppended : function(a) {
        this._selectOnly(a, function(a) { return !db.wasPrepended(a) })
      },
      selectOnlyFromPrepended : function(
          a) { this._selectOnly(a, function(a) { return db.wasPrepended(a) }) }
    });
    var ja = function() { this._crs = null, this._newCrs = null };
    c(ja, {
      attach : function(a) { this._crs = a, this._newCrs = [] },
      getNew : function() { return this._newCrs },
      ...
      _shiftBottomRight : function(a) {
        ...
        if (null != b)
          b.x1 - 1 != a.x && this._createShifted(b.x1 - 1, a.y, a);
        else {
          if (_a.eq("grid", "horizontal") && a.type == K.PREPEND.DEF)
            return;
      ...
      _shiftTopLeft : function(a) {
        ...
        null != b ? b.x2 + 1 != a.x && this._createShifted(b.x2 + 1, a.y, a)
      ...
      shiftAllToRight : function(a) { this._shiftAllTo(a, "x", Za.x2()) },
      shiftAllToLeft : function(a) { this._shiftAllTo(a, "x", 0) },
      shiftAllToTop : function(a) { this._shiftAllTo(a, "y", 0) },
      shiftAllToBottom : function(a) { this._shiftAllTo(a, "y", Za.y2()) }
    });
    var ka = function() { this._crs = null };
    c(ka, {
      attach : function(a) { this._crs = a },
      getSorted : function() { return this._crs },
      _sortForVG : function(a, b) {
        this._crs.sort(function(c, d) {
          return Y.areRoundedOrCeiledEq(c.y, d.y) ? a   ? b ? c.x > d.x ? 1 : -1
                                                          : c.x < d.x ? 1
                                                                      : -1
                                                    : b ? c.x > d.x ? 1 : -1
                                                    : c.x < d.x ? 1
      ...
      _sortForHG : function(a, b) {
        this._crs.sort(function(c, d) {
          return Y.areRoundedOrCeiledEq(c.x, d.x) ? a   ? b ? c.y < d.y ? 1 : -1
                                                          : c.y > d.y ? 1
                                                                      : -1
                                                    : b ? c.y < d.y ? -1 : 1
                                                    : c.y > d.y ? -1
      ...
      sortForPrepend : function() {
        ...
        _a.eq("grid", "vertical") ? this._sortForVG(!0, a)
                                  : this._sortForHG(!0, a)
      },
      sortForAppend : function() {
        var a = "default" == _a.get("append");
        _a.eq("grid", "vertical") ? this._sortForVG(!1, a)
                                  : this._sortForHG(!1, a)
      }
    });
    var la = function() {
      this._collectFn = null, this._createCollectFn(), d(this, {
    ...
    c(la, {
      ...
      filterCollectable : function(a) {
        return Y.filter(a, function(a) { return !this.isNotCollectable(a) },
                        this)
      },
      markAsNotCollectable : function(
          a) { Y.set(a, H.COLL.NOT_COLLECTABLE_DATA, "r") },
      unmarkAsNotCollectable : function(
          a) { Y.rmIfHas(a, H.COLL.NOT_COLLECTABLE_DATA) },
      isNotCollectable : function(
          a) { return Y.has(a, H.COLL.NOT_COLLECTABLE_DATA) },
      collect : function() { return this._collectFn(Za.get()) },
      collectByQuery : function(
          a) { return this.filterCollectable(Y.find.byQuery(Za.get(), a)) },
      collectConnected :
          function() { return Ya.filterConnected(this._collectFn(Za.get())) },
      ...
      sort : function(a) {
        return this.saveOriginalOrder(a),
               a.sort(function(a, b) { return _a.getApi("sort")(a, b, Qb, Y) }),
               this.flushOriginalOrder(a), a
      },
      ...
      flushOriginalOrder : function(a) {
        for (var b = 0; b < a.length; b++)
          Y.rm(a[b], H.COLL.SORT_INDEX_DATA);
      }
    });
    var ma = function() {
    ...
    c(ma, {
      reinit : function() { this._max = 9999, this._min = 1e4 },
      reinitMax : function(
          a) { this._max = "undefined" == typeof a || null == a ? 9999 : a },
      get : function(a) { return Y["int"](Y.get(a, H.GUID_DATA)) },
      set : function(a, b) { Y.set(a, H.GUID_DATA, b) },
      rm : function(a) { Y.rm(a, H.GUID_DATA) },
      markForAppend : function(
          a) { return Y.set(a, H.GUID_DATA, ++this._max), this._max },
      markForPrepend : function(
          a) { return Y.set(a, H.GUID_DATA, --this._min), this._min },
      markIfFirstPrepended : function(a) {
        null == this._firstPrepended &&
            (this._firstPrepended = Y["int"](Y.get(a, H.GUID_DATA)))
      },
      unmarkFirstPrepended : function() { this._firstPrepended = null },
    ...
    var na = function() {};
    c(na, {
      markAsConnected : function(a) { Y.set(a, H.ITEM.IS_CONNECTED_DATA, "y") },
      unmarkAsConnected : function(a) { Y.rm(a, H.ITEM.IS_CONNECTED_DATA) },
      isConnected : function(a) { return Y.has(a, H.ITEM.IS_CONNECTED_DATA) },
      filterConnected : function(a) {
        return Y.filter(a, function(a) { return this.isConnected(a) }, this)
      },
    ...
    c(oa, {
      changeCss : function(a, b, c) {
        for (var b = Ya.filterConnected(Ya.toNative(b)),
                 c = Y.isArray(c) ? c : [ c ], d = 0;
             d < b.length; d++) {
          for (var e = [], f = [],
                   g =
                       function(a, b) {
                   ...
                   h =
                       function(a, b) {
                         f.push(b),
                             Y.css.hasClass(a, b) && Y.css.removeClass(a, b)
                       },
                   i = 0;
               i < c.length; i++)
            "toggle" == a
                ? Y.css.hasClass(b[d], c[i]) ? h(b[d], c[i]) : g(b[d], c[i])
            : "add" == a ? g(b[d], c[i])
                         : "rm" == a && h(b[d], c[i]);
      ...
      _saveEventData : function(a, b, c) {
        for (var d = db.get(a), e = null, f = 0; f < this._eventsData.length;
             f++)
        ...
        null == e && (e = {}, this._eventsData.push(e)),
            e.itemGUID = d, e.added = b, e.removed = c
      },
          ...
          for (var b = 0; b < a.length; b++)
            for (var c = 0; c < this._eventsData.length; c++)
              if (Y["int"](a[b].itemGUID) == this._eventsData[c].itemGUID) {
                ...
                !function(a, b, c) {
                  setTimeout(function() { $a.emit(P.CSS_CHANGE, a, b, c) },
    ...
    var pa = function() {
      this._owCache = [], this._ohCache = [], this._nextOwGUID = 0,
      this._nextOhGUID = 0, this._isActive = !1, this._owAntialias = 0,
      this._ohAntialias = 0
    };
    c(pa, {
      setOuterWidthAntialiasValue : function(a) { this._owAntialias = a },
      setOuterHeightAntialiasValue : function(a) { this._ohAntialias = a },
      ...
      unmarkAsCached : function(a) {
        Y.rmIfHas(a, [
          H.SRM.CACHED_PER_OW_DATA, H.SRM.CACHED_PER_OW_ITEM_GUID_DATA,
          H.SRM.CACHED_PER_OH_DATA, H.SRM.CACHED_PER_OH_ITEM_GUID_DATA
        ])
      },
      _getCachedItemEntry : function(a, b, c) {
        for (var d = 0; d < b.length; d++)
          if (parseInt(b[d].GUID) == parseInt(c))
            return b[d]
      },
      _getOwCachedItemEntry : function(a) {
        return this._getCachedItemEntry(
            a, this._owCache, Y.get(a, H.SRM.CACHED_PER_OW_ITEM_GUID_DATA))
      },
      _getOhCachedItemEntry : function(a) {
        return this._getCachedItemEntry(
            a, this._ohCache, Y.get(a, H.SRM.CACHED_PER_OH_ITEM_GUID_DATA))
      },
      _isCallCached : function(a, b, c, d) {
        if (!Y.has(a, c))
          return !1;
        var e = d(a);
        return b ? null != e.cachedCalls.withMargins
                 : null != e.cachedCalls.withoutMargins
      },
      _isOwCallCached : function(a, b) {
        var c = this;
        return this._isCallCached(
            a, b, H.SRM.CACHED_PER_OW_DATA,
            function(a) { return c._getOwCachedItemEntry(a) })
      },
      _isOhCallCached : function(a, b) {
        var c = this;
        return this._isCallCached(
            a, b, H.SRM.CACHED_PER_OH_DATA,
            function(a) { return c._getOhCachedItemEntry(a) })
      },
      startCachingTransaction : function() { this._isActive = !0 },
      ...
      _callRealOuter : function(a, b, c, d, e, f, g) {
        var h = this, g = g || !1, i = Z.recalcPtWidthFn,
            j = Z.recalcPtHeightFn, k = function(a) {
              return function(b, c, d, e) { return h[a](b, c, !0, d, e, !0) }
            };
        Z.recalcPtWidthFn = k("outerWidth"),
        Z.recalcPtHeightFn = k("outerHeight"),
        f || Z.clearRecursiveSubcallsData();
        var l = g ? "outerHeight" : "outerWidth", m = Z[l](a, b, d, e);
        return c || (m -= g ? this._ohAntialias : this._owAntialias),
               Z.recalcPtWidthFn = i, Z.recalcPtHeightFn = j, m
      },
      _callRealOw : function(
          a, b, c, d, e, f) { return this._callRealOuter(a, b, c, d, e, f) },
      _callRealOh : function(
          a, b, c, d, e,
          f) { return this._callRealOuter(a, b, c, d, e, f, !0) },
      _outer : function(a, b, c, d, e, f, g) {
        var h = arguments, g = g || !1;
        if (h[2] = h[2] || !1, h[5] = h[5] || !1, !this._isActive)
          return g ? this._callRealOh.apply(this, h)
                   : this._callRealOw.apply(this, h);
        var i = null;
        if (!g && this._isOwCallCached(a, b)
                ? i = this._getOwCachedItemEntry(a)
                : g && this._isOhCallCached(a, b) &&
                      (i = this._getOhCachedItemEntry(a)),
            null != i) {
          var j = i.cachedCalls;
          return b ? j.withMargins : j.withoutMargins
        }
        var k = g ? this._callRealOh.apply(this, h)
                  : this._callRealOw.apply(this, h);
        if (!g && Y.has(a, H.SRM.CACHED_PER_OW_DATA) ||
            g && Y.has(a, H.SRM.CACHED_PER_OH_DATA)) {
          var i =
              g ? this._getOhCachedItemEntry(a) : this._getOwCachedItemEntry(a);
          b ? i.cachedCalls.withMargins = k : i.cachedCalls.withoutMargins = k
        } else {
          g ? this._markAsCachedPerOh(a, ++this._nextOhGUID)
      ...
      outerWidth : function(a, b, c, d, e,
                            f) { return this._outer(a, b, c, d, e, f) },
      outerHeight : function(a, b, c, d, e,
                             f) { return this._outer(a, b, c, d, e, f, !0) },
      positionTop : function(a) { return Z.positionTop(a) },
      positionLeft : function(a) { return Z.positionLeft(a) },
      _offset : function(a, b, c, d) {
        var b = b || !1;
        if (b)
          var e = this[c](a), f = this[c](a, !0), g = f - e, h = g / 2,
              i = Z[d](a) - h;
        else
          var i = Z[d](a);
        return i
      ...
      offsetLeft : function(
          a, b) { return this._offset(a, b, "outerWidth", "offsetLeft") },
      offsetTop : function(
          a, b) { return this._offset(a, b, "outerHeight", "offsetTop") },
      viewportWidth :
      ...
      itemSizes : function(a) {
        return {
          width: this.outerWidth(a, !0), height: this.outerHeight(a, !0)
        }
      },
    ...
    var qa = function() {
      d(this, {
        disconnect : function(a) {
          var b = this;
          return a = Ya.filterConnected(Ya.toNative(a)), setTimeout(function() {
                   Jb.sync(), b.disconnect(a, H.DISC_TYPES.HARD), Jb.all()
                 }, H.REFLOW_FIX_DELAY), Wa
        },
        pop : function() {
          var a = Wa.first();
    ...
    c(qa, {
      ...
      _recreateCrs : function() {
        ib.flush(), _a.eq("append", "default") ? Cb.createInitialCr()
                                               : Eb.createInitialCr()
      },
      _scheduleRender : function(a) {
        ...
        for (var c = 0; c < b.length; c++)
          !function(
              a, b) { setTimeout(function() { yb.hide(a) }, H.DISC_DELAY * b) }(
              b[c], c)
      }
    });
    var ra = function() {};
    c(ra, {
      filter : function() {
        var a = cb.collect(), b = cb.collectConnected(),
            c = cb.sort(cb.filter(a)), d = this._findConnItemsToHide(b);
        Hb.disconnect(d), this._recreateGUIDS(c), this._recreateCns(c)
      },
      _findConnItemsToHide : function(a) {
        return Y.filter(a, function(a) { return 0 == cb.filter([ a ]).length },
                        this)
      },
      _recreateGUIDS : function(a) {
        db.reinit();
        for (var b = 0; b < a.length; b++)
          db.markForAppend(a[b])
      },
      _recreateCns : function(a) {
        ...
        for (var d = 0, e = 0; e < a.length; e++) {
          var f = {};
          f[c.c1 + "1"] = d, f[c.c1 + "2"] = d, f[c.c2 + "1"] = 0,
                   f[c.c2 + "2"] = 0, rb.add(a[e], f), d++
        }
      }
    });
    var sa = function() {};
    c(sa, {
      ...
      _resortOnSD : function(a) {
        ...
        for (var c = 0, d = 0; d < a.length; d++) {
          var e = sb.find(a[d]);
          e[b.c1 + "1"] = c, e[b.c1 + "2"] = c, e[b.c2 + "1"] = 0,
                   e[b.c2 + "2"] = 0, c++
        }
      }
    }),
        k = function() {
          this._shouldUpdateZ = !1, this._disableZUpdates = !1,
          this._updateZTimeout = null;
          var a = this;
          Wa.onReposition(function() {
            a._shouldUpdateZ && !a._disableZUpdates &&
                (clearTimeout(a._updateZTimeout),
                 a._updateZTimeout =
                     setTimeout(function() { a._updateZ.call(a) },
                                H.UPDATE_Z_DELAY))
          }),
              $a.onSetSettingForNzer(function(b) {
                for (var c = [ "widthPx", "heightPx", "widthPt", "heightPt" ],
                         d = !1, e = 0;
                     e < c.length; e++)
                  b == c[e] + "As" && (d = !0);
                d && a.updateAs()
              ...
              d(this, {
                disableZUpdates :
                    function() { return a._disableZUpdates = !0, Wa }
              }),
              this.updateAs()
        }, c(k, {
          updateAs : function() {
          ...
          _updateZ : function() {
            var a = function(a) {
              ...
              return a.normArea > b.normArea   ? 1
                     : a.normArea < b.normArea ? -1
                                               : 0
            }, c = function(a) {
              for (var b = {}, c = 0; c < a.length; c++)
            ...
            f.sort(function(a, b) { return a > b ? 1 : b > a ? -1 : 0 });
    ...
    var ta = function() {
      this._onResize = null, this._bindEvents(), d(this, {
        destroy : function() { return this._unbindEvents(), Wa },
        set : function(a, b) { return _a.set(a, b), Wa },
        setApi : function(a, b) { return _a.setApi(a, b), Wa },
        addApi : function(a, b, c) { return _a.addApi(a, b, c), Wa },
        get : function(a) { return _a.get(a) },
        toggle : function(a) { return Wa.setApi("toggle", a) },
        sort : function(a) { return Wa.setApi("sort", a) },
        coordsChanger : function(a) { return Wa.setApi("coordsChanger", a) },
        drag : function(a) { return Wa.setApi("drag", a) },
        rsort : function(a) { return Wa.setApi("rsort", a), Jb.all(), Wa },
        resort : function() { return Jb.sync(), Gb.resort(), Jb.all(), Wa },
        filter : function(a) {
          return Jb.sync(), Wa.setApi("filter", a), Ib.filter(), Jb.all(), Wa
        },
        reposition : function() { return eb.updateAs(), Jb.all(), Wa },
        prepend : function(a, b, c) {
          var d = g("eq", _a);
          if (d("loadImages", !0)) {
            var e = d("prepend", "mirrored") ? L.INS_BEFORE : L.PREPEND;
            hb.schedule(Ya.toNative(a), e,
                        {batchSize : b, batchDelay : c, beforeItem : null})
          } else
            d("prepend", "mirrored") ? Wa.insertBefore(a, null, b, c)
                                     : this.exec(L.PREPEND, a, b, c);
          return Wa
        },
        append : function(a, b, c) {
          return _a.eq("loadImages", !0)
                     ? hb.schedule(Ya.toNative(a), L.APPEND,
                                   {batchSize : b, batchDelay : c})
        ...
        silentRender : function(a, b, c) { return Bb.exec(a, b, c), Wa },
        getSilent : function(a) { return Bb.getScheduled(a) },
        insertBefore : function(a, b, c, d) {
          return _a.eq("loadImages", !0)
                     ? hb.schedule(
                           Ya.toNative(a), L.INS_BEFORE,
                           {batchSize : c, batchDelay : d, beforeItem : b})
        ...
        insertAfter : function(a, b, c, d) {
          return _a.eq("loadImages", !0)
                     ? hb.schedule(
                           Ya.toNative(a), L.INS_AFTER,
                           {batchSize : c, batchDelay : d, afterItem : b})
                     : this.exec(L.INS_AFTER, a, c, d, b),
                 Wa
        },
        appendNew : function(a,
                             b) { return Wa.append(Wa.collectNew(), a, b), Wa },
        prependNew : function(
            a, b) { return Wa.prepend(Wa.collectNew(), a, b), Wa },
        rotate : function(a, b, c, d) {
          Wa.toggle(b);
          var a = Ya.toNative(a);
          return "undefined" == typeof c
                     ? (yb.rotate(a), Wa)
                     : (Mb.scheduleFnExec(a, c, d,
                                          function(a) { yb.rotate(a) }),
                        Wa)
        }
      })
    };
    c(ta, {
      _bindEvents : function() {
        var a = g("get", _a), b = null;
        this._onResize = function() {
          return null == a("vpResizeDelay")
                     ? void Wa.reposition()
                     : (clearTimeout(b),
                        void (b = setTimeout(function() { Wa.reposition() },
                                             a("vpResizeDelay"))))
      ...
      exec : function(a, b, c, d, e) {
        setTimeout(function() { Mb.schedule(a, b, c, d, e) },
                   H.REFLOW_FIX_DELAY)
      },
      execSilentAppend : function(
          a, b, c) { Bb.schedule(Ya.toNative(a)), this.exec(L.APPEND, a, b, c) }
    });
    var ua = function() {
    ...
    c(ua, {
      _init : function() {
        var a = this, b = function(b, c, d) {
          for (var e in b) {
            var f = b[e];
            this._callbacks[f] = c ? null : [], function(b) {
              d["on" + b] = function(
                  d) { c ? a._callbacks[b] = d : a._callbacks[b].push(d) }
            }(f)
          }
        };
      ...
      emit : function(a) {
        var b = this._getArgs(P, a, arguments), c = this;
        if (a == P.INSERT)
          return void this._emitInsertEvent(b[0]);
        for (var d = 0; d < this._callbacks[a].length; d++)
          a == P.REPOSITION || a == P.REPOSITION_END
              ? !function(a, b) { setTimeout(function() { a.apply(c, b) }, 0) }(
      ...
      _emitInsertEvent : function(a) {
        ...
        null != this._insertEvTimeout &&
            (clearTimeout(this._insertEvTimeout), this._insertEvTimeout = null,
             a = a.concat(this._insertEvItems));
        var c = this;
        this._insertEvItems = a,
        this._insertEvTimeout =
            setTimeout(function() { c._insertEvTimeout = null, b.call(c, a) },
                       20)
      },
      ...
      rmInternal : function(
          a) { this._getArgs(Q, a, arguments), this._callbacks[a] = null }
    });
    var va = function() {
      var a = this;
      d(this, {
        first : function() { return a.get("first") },
        last : function() { return a.get("last") },
        next : function(b) { return a.get("next", b) },
        prev : function(b) { return a.get("prev", b) },
        all : function() { return a.get("all") }
      })
    };
    c(va, {
      get : function(a, b) {
        ...
        if (0 == c.length)
          return "all" == a ? [] : null;
        if (c = vb.sortForReappend(c), "first" == a)
          return c[0].item;
        if ("last" == a)
          return c[c.length - 1].item;
        var d = function(a,
                         b) { return db.get(a) == db.get(Ya.toNative(b)[0]) };
        if ("next" == a) {
          for (var e = 0; e < c.length; e++)
            if (d(c[e].item, b))
    ...
    var wa = function() { this._last = null };
    c(wa, {
      isInitial : function(
          a) { return null == this._last ? (this._last = a, !0) : !1 },
      isSameAsPrev : function(
          a) { return this._last != a ? (this._last = a, !1) : !0 },
      setLast : function(a) { this._last = a }
    });
    var xa = function(a, b, c, d, e) {
      this._op = b, this._crInitialCr = c, this._addItemCrs = d,
      this._cantFitCond = e;
    ...
    c(xa, {
      initCrs : function(a, b, c) {
        return gb.isInitial(this._op)
                   ...
                   : void (gb.isSameAsPrev(this._op) ||
                           (this._recreateCrs(), jb["rmIntFrom" + a](),
                            jb["rmAllToo" + b + "FromMost" + c]()))
      },
      _createInitialCr : function() { this._crInitialCr(ib, Za) },
      ...
      cleanCrs : function(
          a, b,
          c) { jb["rmAllToo" + b + "FromMost" + c](), jb["rmIntFrom" + a]() },
      filterCrs : function(a, b, c, d, e) {
        var f = ib.getClone();
        return nb.attach(f), nb["selectOnlyFrom" + a](b),
               f = nb.getSelected(),
               _a.eq("intersections", !0)
                   ? (ob.attach(f), ob.shiftAll(), f = ob.getNew())
                   : (nb.attach(f), nb["selectOnlyMost" + c](b),
                      f = nb.getSelected(), ob.attach(f),
                      ob["shiftAllTo" + d](b), f = ob.getNew()),
               pb.attach(f), pb["sortFor" + e](), pb.getSorted()
      },
        ...
        for (var i = null, j = 0; j < b.length; j++) {
          ...
          if (!this._cantFitCond.call(this, k)) {
            ...
            if (!tb.isIntersectingAny(l, k)) {
              ...
              if (!sb["isAnyGUID" + g + "Than"](m, a) &&
                  (_a.eq("intersections", !1) &&
                       rb["isIntMoreThanOneCn" + h](i) && (i = null),
                   null != i))
                break
            }
          }
      ...
      createCn : function(a, b, c) {
        var d = rb.add(a, b);
        return _a.eq("intersections", !1) &&
                   (_a.eq("grid", "vertical")
                        ? rb.expandYAllRowCnsToMostTall(d)
                        : rb.expandXAllColCnsToMostWide(d)),
               this._addItemCrs.call(this, d, db.get(a)), d
      },
      render : function(a, b) {
        if (_a.eq("intersections", !0))
          yb.show(b);
        else {
          if (_a.eq("grid", "vertical"))
            var c = rb.getLastRowYExpandedCns();
          else
            var c = rb.getLastColXExpandedCns();
          for (var d = 0; d < c.length; d++)
      ...
      fixAllXYPosAfterPrepend : function(a, b) {
        if (_a.eq("grid", "vertical"))
          var c = rb.fixAllYPosAfterPrepend(a, b);
        else
          var c = rb.fixAllXPosAfterPrepend(a, b);
        return c
      },
      renderAfterPrependFix : function(a) { yb.render(rb.get(), [ a ]) }
    });
    var ya = function() { this._fixRoundingVal = 1 };
    c(ya, {
      fixLowRounding : function(a) { return a - this._fixRoundingVal },
      fixHighRounding : function(a) { return a + this._fixRoundingVal }
    }),
        y = function() { this._cells = [] }, c(y, {
          cells : function() { return this._cells },
          discretize : function() {
            var a = sb.getMinWidth(), b = sb.getMinHeight(),
          ...
          intCellsToCoords : function(a) {
            for (var b = {
                   ...
                   y2 : a[0].y2
                     ...
                     c = 1;
                 c < a.length; c++)
              a[c].x1<b.x1 && (b.x1 = a[c].x1), a[c].x2>b.x2 &&
                  (b.x2 = a[c].x2),
                  a[c].y1<b.y1 && (b.y1 = a[c].y1), a[c].y2>b.y2 &&
                      (b.y2 = a[c].y2);
            return b
          },
          ...
          getAllCellsWithIntCenter : function(a) {
            for (var b = [], c = [], d = {rows : 0, cols : 0}, e = function(a) {
                   for (var b = 0; b < c.length; b++)
                     if (c[b] == a)
                       return !0;
                   return !1
                 }, f = 0; f < this._cells.length; f++) {
              for (var g = !1, h = [], i = 0; i < this._cells[f].length; i++) {
                var j = this._cells[f][i], k = {
                  x1 : j.centerX,
                  x2 : j.centerX,
                  y1 : j.centerY,
                  y2 : j.centerY
        ...
        z = function() {}, c(z, {
          ...
          _coords : function(a) {
            return a.isInt = !1, a.centerX = a.x1 + (a.x2 - a.x1 + 1) / 2,
                   a.centerY = a.y1 + (a.y2 - a.y1 + 1) / 2, a
          },
          ...
          _onRevAppend : function(a, b, c, d, e) {
            for (var f = [], g = -1, h = !0; h;) {
              for (var i = [], j = c + 1, k = !0; k;)
                j -= b, 0 > j ? k = !1 : i.unshift(this._coords(e(g, j, a, b)));
          ...
          discretizeOnDefAppend : function(a, b) {
            ...
            return _a.eq("grid", "vertical")
                       ...
                       : this._rev(
                             this._onDefAppend(a, b, Za.x2(), Za.y2(), c.hg))
          },
          discretizeOnRevAppend : function(a, b) {
            ...
            return _a.eq("grid", "vertical")
                       ...
                       : this._rev(
                             this._onRevAppend(a, b, Za.y2(), Za.x2(), c.hg))
          },
          _normalizeCnXYCoords : function(a, b, c, d, e, f, g) {
            var h = b[e] - b[d] + 1, i = Xa["outer" + c](a, !0);
            return (i > h || h > i) &&
                       (g && _a.eq("append", "default") ? b[d] = b[e] - i + 1
                                                        : b[e] = b[d] + i - 1),
                   b[d] < 0 && (b[d] = 0, b[e] = i - 1),
                   b[e] > f && (b[e] = f, b[d] = b[e] - i + 1), b
          },
          normalizeCnXCoords : function(a, b) {
            var c = [ a, b, "Width", "x1", "x2", Za.x2() ];
            return c.push(_a.eq("grid", "vertical")),
        ...
        B =
            function() {
          this._items = [], this._isDragging = !1, this._areEventsBinded = !1,
          this._origReposQueueSize = null,
          this._coordsChanger = Tb.getCoordsChanger(), this._createEvents(),
          _a.eq("dragifier", !1) || this._bindEvents(), d(this, {
        ...
        c(B, {
          _createEvents : function() {
            ...
            this._touch = {
              start : function(b) {
                ...
                a._isDragging &&
                    (b.preventDefault(),
                     setTimeout(function() { a._touchEnd.call(a, b) }, 0))
              },
              move : function(b) {
                console.log(b);
                a._isDragging &&
                    (b.preventDefault(),
                     setTimeout(function() { a._touchMove.call(a, b) }, 0))
              }
            },
            this._mouse = {
              down : function(b) { a._mouseDown.call(a, b) },
              up : function(
                  b) { setTimeout(function() { a._mouseUp.call(a, b) }, 0) },
              move : function(
                  b) { setTimeout(function() { a._mouseMove.call(a, b) }, 0) }
            }
          },
          _touchStart : function(a) {
            var b = this, c = a.changedTouches[0],
                d = b._findClosestConnected(a.target);
            return null != d
                       ? (b._initDrag.call(b, a),
                          b._isAlreadyDraggable(d)
                              ? void b._findAlreadyDraggable(d).addDragId(
                                    c.identifier)
          ...
          _mouseDown : function(a) {
            var b = this, c = b._findClosestConnected(a.target);
            null == c || Y.browsers.isAndroidUC() ||
                (b._initDrag.call(b, a), b._initDraggableItem.call(b, c, a, !1))
          },
          _mouseUp : function(a) {
            var b = this;
            b._isDragging && !Y.browsers.isAndroidUC() &&
          ...
          _initDrag : function(a) {
            a.preventDefault(), this._reposQueueOff(),
                Tb.getSelectToggler().disableSelect(),
                Xa.startCachingTransaction(), this._isDragging = !0
          },
          _endDrag : function() {
            this._reposQueueOn(), Tb.getSelectToggler().enableSelect(),
                Xa.stopCachingTransaction(), this._isDragging = !1
          },
          _initDraggableItem : function(a, b, c) {
            var d = this._createDraggableItem();
            d.bind(a, b.pageX, b.pageY), c && d.addDragId(b.identifier),
                this._items.push(d)
          },
          ...
          _findClosestConnected : function(a) {
            if (a == Za.get())
              return null;
            for (var b = _a.get("dragifier"),
                     c = "string" == typeof b || b instanceof String, d = null,
                     e = null, f = !1;
                 null == d && e != Za.get();)
          ...
          _createDraggableItem :
              function() { return _a.eq("dragifierMode", "i") ? new D : new F },
          ...
          _findDraggableById : function(a, b) {
            for (var b = b || !1, c = 0; c < this._items.length; c++)
              if (this._items[c].hasDragId(a))
                return b ? {item : this._items[c], itemIndex : c}
                         : this._items[c]
          },
          render : function(a, b, c) { this._coordsChanger(a, b, c, Y) }
        }),
        C =
            function() {
        ...
        c(C, {
          ...
          _getOffset : function(a, b, c, d, e, f, g) {
            var b = b || !1, h = sb.find(a);
            if (_a.eq("intersections", !1) && _a.eq("grid", c))
              var i = h[d + "Offset"];
            else
              var i = 0;
            if (!b)
              return this._gridOffset[e] + h[g] + i;
            var j = Xa["outer" + f](a), k = Xa["outer" + f](a, !0), l = k - j,
                m = l / 2;
            return this._gridOffset[e] + h[g] - m + i
          },
          _getOffsetLeft : function(a, b) {
            return this._getOffset(a, b, "horizontal", "h", "left", "Width",
                                   "x1")
          },
          ...
          createClone : function(a) {
            var b = a.cloneNode(!0), c = {
              left : this._getOffsetLeft(a),
              top : this._getOffsetTop(a)
            };
            return cb.markAsNotCollectable(b), _a.getApi("drag")(b, a, Xa),
                   Y.hasTransitions() &&
                   ...
                   document.body.appendChild(b), Xb.render(b, c.left, c.top), b
          },
          createPointer : function(a) {
            ...
            var e = parseFloat(d.marginLeft), f = parseFloat(d.marginTop);
            return Xb.render(
                       c, b.left - this._gridOffset.left + (isNaN(e) ? 0 : e),
                       b.top - this._gridOffset.top + (isNaN(f) ? 0 : f)),
                   c
          },
          calcCloneNewDocPosition : function(a, b, c) {
            return {
              x: b - Xa.outerWidth(a, !0) / 2 -
                  -1 * this._itemCenterCursorOffset.x,
                  y: c - Xa.outerHeight(a, !0) / 2 -
          ...
          repositionItems : function() {
            if (_a.eq("append", "default"))
              var a = function() { Cb.createInitialCr() };
            else
              var a = function() { Eb.createInitialCr() };
            ib.setNextFlushCb(a), $a.onRepositionEndForDrag(function() {
              for (var a = vb.sortForReappend(rb.get()), b = [], c = 0;
                   c < a.length; c++)
                b.push(a[c].item);
              $a.emit(P.DRAG_END, b)
            }),
          ...
          _reposition : function() {
            return Y.browsers.isAndroidFirefox() || Y.browsers.isAndroidUC()
                       ? (clearTimeout(this._repositionTimeout),
                          void (this._repositionTimeout =
                                    setTimeout(function() { Jb.all() },
        ...
        c(D, {
          ...
          addDragId : function(a) { this._dragIds.push(a) },
          hasDragId : function(a) { return Vb.hasDragId(a, this._dragIds) },
          rmDragId : function(a) { Vb.rmDragId(a, this._dragIds) },
          getDragIdsCount : function() { return this._dragIds.length },
          bind : function(a, b, c) {
            this._item = a, Vb.initItem(a), Vb.calcGridOffsets(),
            Vb.findItemCenterCursorOffsets(a, b, c),
            this._clone = Vb.createClone(a), Vb.hideItem(a)
          },
          unbind : function() {
            document.body.removeChild(this._clone), Vb.showItem(this._item),
                this._item = null
          },
          ...
          _getNewIntCns : function(a) {
            for (var b = db.get(this._item),
                     c = tb.getAllWithIntersectedCenter(a), d = [], e = 0;
                 e < c.length; e++)
          ...
          _swapGUIDS : function(a) {
            ...
            db.set(this._item, c.itemGUID), db.set(this._clone, c.itemGUID),
                db.set(c.item, b)
          },
          _swapPositions : function(a) {
            ...
            var c = a[0], d = db.get(c.item), e = db.get(this._item);
            return db.set(this._item, d), db.set(c.item, e),
                   this._swapCnData(b, c, d), !0
          },
        ...
        E = function() {}, c(E, {
          getIntCellsData : function(a) {
            return 0 == a["int"].cols && 0 == a["int"].rows &&
          ...
          isIntEnoughRowsAndCols : function(a, b) {
            return b["int"].rows < a["int"].rows ||
                           b["int"].cols < a["int"].cols
                       ? !1
                       : !0
          },
          normalizeOverflowedCells : function(a, b, c) {
            ...
            if (c["int"].cols > b["int"].cols)
              for (var f = c["int"].cols - b["int"].cols, g = 0; g < a.length;
                   g++)
                for (var e = 0; f > e; e++)
                  a[g].pop();
        ...
        F = function() {
          this._dragIds = [], this._item = null, this._itemCn = null,
          this._clone = null, this._pointer = null, this._discretizer = new y
        }, c(F, {
          get : function() { return this._item },
          addDragId : function(a) { this._dragIds.push(a) },
          hasDragId : function(a) { return Vb.hasDragId(a, this._dragIds) },
          ...
          bind : function(a, b, c) {
            ...
            Vb.calcGridOffsets(), Vb.findItemCenterCursorOffsets(a, b, c),
            this._clone = Vb.createClone(a),
            this._pointer = Vb.createPointer(a), this._discretizer.discretize(),
            this._discretizer.markIntCellsBy(this._itemCn), Vb.hideItem(a)
          },
          _initCn : function() {
          ...
          unbind : function() {
            document.body.removeChild(this._clone),
                Za.get().removeChild(this._pointer), Vb.showItem(this._item),
          ...
          dragMove : function(a, b) {
            ...
            Wb.isAnyIntCellEmpty(f) && Wb.isIntEnoughRowsAndCols(e, f) &&
                this._repositionGrid(
                    Wb.normalizeOverflowedCells(f.intCells, e, f))
          },
          _repositionGrid : function(a) {
            var b = this._discretizer.intCellsToCoords(a);
            b = Ub.normalizeCnXCoords(this._item, b),
            b = Ub.normalizeCnYCoords(this._item, b), this._adjustPosition(b),
            this._discretizer.markIntCellsBy(b),
            setTimeout(function() { Vb.repositionItems() },
          ...
          _adjustPosition : function(a) {
            ...
            var d = g("get", _a);
            _a.getApi("coordsChanger")(this._item, a.x1 + "px", a.y1 + "px",
                                       d("coordsChangeTime"),
                                       d("coordsChangeTiming"), Y, X, d),
    ...
    var za = function() {
      this._position = new xa(
          this, L.APPEND,
          function(a) { a.create(K.APPEND.DEF, K.RIGHT.TOP, 0, 0) },
          function(a, b) {
            a.y2 + 1 <= Za.y2() &&
                ib.create(K.APPEND.DEF, K.BOTTOM.LEFT, parseFloat(a.x1),
                          parseFloat(a.y2 + 1), Y["int"](b)),
                ib.create(K.APPEND.DEF, K.RIGHT.TOP, parseFloat(a.x2 + 1),
                          parseFloat(a.y1), Y["int"](b))
          },
          function(a) { return a.y2 > fb.fixHighRounding(Za.y2()) })
    };
    c(za, {
      position : function(a) {
        ...
        var c = b.filterCrs("Prepended", K.RIGHT.TOP, "Right", "Top", "Append"),
            d = b.createCn(a,
                           b.findCnCoords(a, c, "HgAppend", "BehindX", "x2",
                                          "Smaller", "X"),
                           c);
        rb.attachToRanges(d), b.cleanCrs("Right", "Left", "Right"),
            b.render(a, d)
      }
    });
    var Aa = function() { this._cns = [] };
    c(Aa, {
      reinitRanges : function() { ub.init("x1", "x2") },
      attachToRanges : function(
          a) { ub.attachCn(a, rb.get().length - 1, "x1", "x2") },
      mapAllIntAndLeftCns : function(a) {
        var b = ub;
        return ub.mapAllIntAndSideCns(a, "x", "x1", "x2", b.lastRngIndexFn(),
                                      b.lastRngIndexFn(),
                                      b.lowerCrCnIndexesFn(), b.decFn())
      },
      mapAllIntAndRightCns : function(a) {
        var b = ub;
        return ub.mapAllIntAndSideCns(a, "x", "x1", "x2", b.firstRngIndexFn(),
                                      b.lastRngIndexFn(),
                                      b.upperCrCnIndexesFn(), b.incFn())
      },
      getAllIntYCns : function(
          a) { return ub.getAllCnsFromIntRange(a.x, "x1", "x2") },
      getAllIntYAndLeftCns : function(
          a) { return ub.getAllCnsFromIntAndTLSideRgs(a.x, "x1", "x2") },
      getAllIntYAndRightCns : function(
          a) { return ub.getAllCnsFromIntAndRBSideRgs(a.x, "x1", "x2") },
      getLastColXExpandedCns : function() { return wb.getLastXYExpandedCns() },
      isIntMoreThanOneCnX : function(
          a) { return wb.isIntMoreThanOneCnXY(a, "x1", "x2") },
      getMostWideFromAllXIntCns : function(
          a) { return wb.getMostBigFromAllXYIntCns(a, "x1", "x2") },
      getAllXIntCns : function(a) { return wb.getAllXYIntCns(a, "x1", "x2") },
      ...
      restore : function(a) { this._cns = this._cns.concat(a) },
      add : function(a, b) {
        var c = sb.create(a, b);
        return this._cns.push(c), $a.emit(P.REPOSITION, c.item, c, this), c
      },
      rm : function(a) { sb.rm(this._cns, a) },
      restoreOnSortDispersion : function(a) {
        sb.restoreOnSortDispersion(
            a,
            function(a, b, c) {
              for (var d = b.y2 + 1, e = 0; e < a.length; e++)
                c(a[e], b.x1, d++)
            },
            function(a, b, c) {
              for (var d = b.y1 - 1, e = 0; e < a.length; e++)
                c(a[e], b.x1, d--)
            }),
            this.restore(a)
      },
      getAllBehindX : function(
          a) { return sb.getAllBACoord(a, function(a, b) { return a.x1 > b }) },
      getAllBeforeX : function(
          a) { return sb.getAllBACoord(a, function(a, b) { return a.x2 < b }) },
      fixAllXPosAfterPrepend : function(
          a, b) { return sb.fixAllXYPosAfterPrepend(a, b, "x", "x1", "x2") }
    });
    var Ba = function() {};
    c(Ba, {
      find : function(a, b, c) {
        var d = Xa.itemSizes(b), e = parseFloat;
        return a == L.APPEND ? {
          x1 : e(c.x),
          x2 : e(c.x + d.width - 1),
          y1 : e(c.y),
    ...
    var Ca = function() {
      this._position = new xa(
          this, L.PREPEND,
          function(a, b) { a.create(K.PREPEND.DEF, K.TOP.RIGHT, 0, b.y2()) },
          function(a, b) {
            a.y1 - 1 >= 0 &&
                ib.create(K.PREPEND.DEF, K.TOP.RIGHT, parseFloat(a.x2),
                          parseFloat(a.y1 - 1), Y["int"](b)),
                ib.create(K.PREPEND.DEF, K.LEFT.BOTTOM, parseFloat(a.x1 - 1),
                          parseFloat(a.y2), Y["int"](b))
          },
          function(a) { return a.y1 < fb.fixLowRounding(0) })
    };
    c(Ca, {
      position : function(a) {
        var b = this._position;
        b.initCrs("Left", "Right", "Left");
        var c = b.filterCrs("Appended", K.LEFT.BOTTOM, "Left", "Bottom",
                            "Prepend"),
            d = b.createCn(a,
                           b.findCnCoords(a, c, "HgPrepend", "BeforeX", "x1",
                                          "Bigger", "X"),
                           c);
        db.markIfFirstPrepended(a);
        var e = b.fixAllXYPosAfterPrepend(d, ib.get());
        rb.attachToRanges(d), b.cleanCrs("Left", "Right", "Left"),
            e && b.renderAfterPrependFix(d), b.render(a, d)
      }
    });
    var Da = function() {
      this._position = new xa(
          ...
          function(
              a,
              b) { a.create(K.APPEND.REV, K.TOP.LEFT, 0, parseFloat(b.y2())) },
          function(a, b) {
            a.y1 - 1 >= 0 &&
                ib.create(K.APPEND.REV, K.TOP.LEFT, parseFloat(a.x1),
                          parseFloat(a.y1 - 1), Y["int"](b)),
                ib.create(K.APPEND.REV, K.RIGHT.BOTTOM, parseFloat(a.x2 + 1),
                          parseFloat(a.y2), Y["int"](b))
          },
          function(a) { return a.y1 < fb.fixLowRounding(0) })
    };
    c(Da, {
      position : function(a) {
        var b = this._position;
        b.initCrs("Right", "Left", "Right");
        var c = b.filterCrs("Prepended", K.RIGHT.BOTTOM, "Right", "Bottom",
                            "Append"),
            d = b.createCn(a,
                           b.findCnCoords(a, c, "HgAppend", "BehindX", "x2",
                                          "Smaller", "X"),
    ...
    var Ea = function() {
      this._position = new xa(
          this, L.REV_PREPEND,
          function(a, b) { a.create(K.PREPEND.REV, K.LEFT.TOP, 0, 0) },
          function(a, b) {
            a.y2 + 1 <= Za.y2() &&
                ib.create(K.PREPEND.REV, K.BOTTOM.RIGHT, parseFloat(a.x2),
                          parseFloat(a.y2 + 1), Y["int"](b)),
                ib.create(K.PREPEND.REV, K.LEFT.TOP, parseFloat(a.x1 - 1),
                          parseFloat(a.y1), Y["int"](b))
          },
          function(a) { return a.y2 > fb.fixHighRounding(Za.y2()) })
    };
    ...
    var Fa = function() {
      this._position = new xa(
          ...
          function(a) { return a.x2 > fb.fixHighRounding(Za.x2()) })
    };
    c(Fa, {
      position : function(a) {
        var b = this._position;
        b.initCrs("Bottom", "Top", "Bottom");
        var c = b.filterCrs("Prepended", K.BOTTOM.LEFT, "Bottom", "Left",
                            "Append"),
            d = b.createCn(a,
                           b.findCnCoords(a, c, "VgAppend", "BelowY", "y2",
                                          "Smaller", "Y"),
                           c);
        rb.attachToRanges(d), b.cleanCrs("Bottom", "Top", "Bottom"),
            b.render(a, d)
      }
    });
    var Ga = function() { this._cns = [] };
    c(Ga, {
      reinitRanges : function() { ub.init("y1", "y2") },
      attachToRanges : function(
          a) { ub.attachCn(a, rb.get().length - 1, "y1", "y2") },
      mapAllIntAndTopCns : function(a) {
        var b = ub;
        return ub.mapAllIntAndSideCns(a, "y", "y1", "y2", b.lastRngIndexFn(),
                                      b.lastRngIndexFn(),
                                      b.lowerCrCnIndexesFn(), b.decFn())
      },
      mapAllIntAndBottomCns : function(a) {
        var b = ub;
        return ub.mapAllIntAndSideCns(a, "y", "y1", "y2", b.firstRngIndexFn(),
                                      b.lastRngIndexFn(),
                                      b.upperCrCnIndexesFn(), b.incFn())
      },
      getAllIntXCns : function(
          a) { return ub.getAllCnsFromIntRange(a.y, "y1", "y2") },
      getAllIntXAndTopCns : function(
          a) { return ub.getAllCnsFromIntAndTLSideRgs(a.y, "y1", "y2") },
      getAllIntXAndBottomCns : function(
          a) { return ub.getAllCnsFromIntAndRBSideRgs(a.y, "y1", "y2") },
      getLastRowYExpandedCns : function() { return wb.getLastXYExpandedCns() },
      isIntMoreThanOneCnY : function(
          a) { return wb.isIntMoreThanOneCnXY(a, "y1", "y2") },
      getMostTallFromAllYIntCns : function(
          a) { return wb.getMostBigFromAllXYIntCns(a, "y1", "y2") },
      getAllYIntCns : function(a) { return wb.getAllXYIntCns(a, "y1", "y2") },
      ...
      restoreOnSortDispersion : function(a) {
        sb.restoreOnSortDispersion(
            a,
            function(a, b, c) {
              for (var d = b.x2 + 1, e = 0; e < a.length; e++)
                c(a[e], d++, b.y1)
            },
            function(a, b, c) {
              for (var d = b.x1 - 1, e = 0; e < a.length; e++)
                c(a[e], d--, b.y1)
            }),
            this.restore(a)
      },
      getAllBelowY : function(
          a) { return sb.getAllBACoord(a, function(a, b) { return a.y1 > b }) },
      getAllAboveY : function(
          a) { return sb.getAllBACoord(a, function(a, b) { return a.y2 < b }) },
      fixAllYPosAfterPrepend : function(
          a, b) { return sb.fixAllXYPosAfterPrepend(a, b, "y", "y1", "y2") }
    });
    var Ha = function() {};
    c(Ha, {
      find : function(a, b, c) {
    ...
    var Ia = function() {
      this._position = new xa(
          this, L.PREPEND,
          function(a) { a.create(K.PREPEND.DEF, K.RIGHT.BOTTOM, 0, 0) },
          function(a, b) {
            a.x2 + 1 <= Za.x2() &&
                ib.create(K.PREPEND.DEF, K.RIGHT.BOTTOM, parseFloat(a.x2 + 1),
                          parseFloat(a.y2), Y["int"](b)),
                ib.create(K.PREPEND.DEF, K.TOP.LEFT, parseFloat(a.x1),
                          parseFloat(a.y1 - 1), Y["int"](b))
          },
          function(a) { return a.x2 > fb.fixHighRounding(Za.x2()) })
    };
    c(Ia, {
      position : function(a) {
        ...
        var c = b.filterCrs("Appended", K.TOP.LEFT, "Top", "Left", "Prepend"),
            d = b.createCn(a,
                           b.findCnCoords(a, c, "VgPrepend", "AboveY", "y1",
                                          "Bigger", "Y"),
                           c);
        db.markIfFirstPrepended(a);
        var e = b.fixAllXYPosAfterPrepend(d, ib.get());
        rb.attachToRanges(d), b.cleanCrs("Top", "Bottom", "Top"),
            e && b.renderAfterPrependFix(d), b.render(a, d)
      }
    });
    var Ja = function() {
      this._position = new xa(
          ...
          function(
              a,
              b) { a.create(K.APPEND.REV, K.LEFT.TOP, parseFloat(b.x2()), 0) },
          function(a, b) {
            a.x1 - 1 >= 0 &&
                ib.create(K.APPEND.REV, K.LEFT.TOP, parseFloat(a.x1 - 1),
                          parseFloat(a.y1), Y["int"](b)),
                ib.create(K.APPEND.REV, K.BOTTOM.RIGHT, parseFloat(a.x2),
                          parseFloat(a.y2 + 1), Y["int"](b))
          },
          function(a) { return a.x1 < fb.fixLowRounding(0) })
    };
    c(Ja, {
      position : function(a) {
        var b = this._position;
        b.initCrs("Bottom", "Top", "Bottom");
        var c = b.filterCrs("Prepended", K.BOTTOM.RIGHT, "Bottom", "Right",
                            "Append"),
            d = b.createCn(a,
                           b.findCnCoords(a, c, "VgAppend", "BelowY", "y2",
                                          "Smaller", "Y"),
    ...
    var Ka = function() {
      this._position = new xa(
          this, L.REV_PREPEND,
          function(a, b) { a.create(K.PREPEND.REV, K.LEFT.BOTTOM, b.x2(), 0) },
          function(a, b) {
            a.x1 - 1 >= 0 &&
                ib.create(K.PREPEND.REV, K.LEFT.BOTTOM, parseFloat(a.x1 - 1),
                          parseFloat(a.y2), Y["int"](b)),
                ib.create(K.PREPEND.REV, K.TOP.RIGHT, parseFloat(a.x2),
                          parseFloat(a.y1 - 1), Y["int"](b))
          },
          function(a) { return a.x1 < fb.fixLowRounding(0) })
    };
    ...
    var La = function() {
      this._grid = null, this._markingFn = null, this._resizeTimeout = null,
      this._createMarkingFn(), this._toNative(a), this._adjustCSS(),
      d(this,
        {grid : this.get, gridWidth : this.width, gridHeight : this.height})
    };
    c(La, {
      ...
      _toNative : function(a) {
        Y.isJquery(a)                      ? this._grid = a.get(0)
        : Y.isNative(a)                    ? this._grid = a
        : Y.isArray(a) && Y.isNative(a[0]) ? this._grid = a[0]
                                           : e(O.GRID_NOT_NATIVE)
      },
      _adjustCSS : function() {
        var a = Z.getComputedCSS(this._grid);
        "relative" != a.position && "absolute" != a.position &&
            Y.css.set(this._grid, {position : "relative"})
      },
      get : function() { return this._grid },
      x2 : function() { return Xa.outerWidth(this._grid, !1, !0) - 1 },
      y2 : function() { return Xa.outerHeight(this._grid, !1, !0) - 1 },
            ...
            this._resizeTimeout = setTimeout(function() {
              return Kb.isEmpty()
                         ? void (_a.eq("grid", "vertical")
                                     ? a._resize.call(
                                           a, "y2", "height",
                                           function() { return a.y2() })
                                     : a._resize.call(
                                           a, "x2", "width",
                                           function() { return a.x2() }))
      ...
      _resize : function(a, b, c) {
        ...
        l = function() { this._batches = [], this._loaded = [] }, c(l, {
          schedule : function(a, b, c) {
            if (0 == a.length)
              return this._batches.push(
                         {items : a, images : [], op : b, data : c}),
                     void this._checkLoad();
            var d = this._findImages(a);
            if (this._batches.push({items : a, images : d, op : b, data : c}),
                0 == d.length)
          ...
          onLoad : function(a) { this._loaded.push(a.src), this._checkLoad() },
          _checkLoad : function() {
            for (var a = 0; a < this._batches.length; a++) {
              for (var b = !0, c = this._batches[a].images, d = 0; d < c.length;
                   d++)
                if (!c[d].isLoaded()) {
                  b = !1;
                  break
              ...
              this._callOp(this._batches[a].items, this._batches[a].op,
                           this._batches[a].data),
              this._batches.splice(a, 1), a--
            }
          },
          _callOp : function(a, b, c) {
            var d = c.batchSize, f = c.batchDelay;
            b == L.APPEND || b == L.PREPEND ? ab.exec(b, a, d, f)
            : b == L.SIL_APPEND             ? ab.execSilentAppend(a, d, f)
            : b == L.INS_BEFORE             ? ab.exec(b, a, d, f, c.beforeItem)
            : b == L.INS_AFTER              ? ab.exec(b, a, d, f, c.afterItem)
                                            : e("Wrong op.")
          }
        }),
        m = function(a) {
          this._image = a, this._loadedImage = null, this._isLoaded = !1,
          this._onLoad = null, this._onError = null
        }, c(m, {
          _bindEvents : function() {
            var a = this;
            a._onLoad = function() { a._load.call(a) },
            a._onError = function() { a._error.call(a) },
          ...
          _loader : function() { return new Image },
          ...
          _load : function() { this._isLoaded = !0, hb.onLoad(this._image) },
          _error : function() { this._isLoaded = !0, hb.onLoad(this._image) }
        });
    var Ma = function() {};
    c(Ma, {
      exec : function(a) {
        var b = this;
        Pb.exec(a, function(a) { b._append.call(b, a) })
      },
      _append : function(a) {
        db.markForAppend(a),
      ...
      execInsBefore : function(a, b) {
        var c = this;
        Pb.execInsertBA(a, b, function(a) { c.exec.call(c, a) },
                        function() { return 0 },
                        function(a, b) { return a.splice(b, a.length - b) }, -1,
                        function(a) { Jb.from(a[0]) })
      },
      execInsAfter : function(a, b) {
        var c = this;
        Pb.execInsertBA(
            a, b, function(a) { c.exec.call(c, a) },
            function(a) { return a.length - 1 },
            function(a, b) { return a.splice(b + 1, a.length - b - 1) }, 1,
            function(a) { a.length > 0 && Jb.from(a[0]) })
      }
    });
    var Na = function() {};
    c(Na, {
      exec : function(a) {
        var b = this;
        Pb.exec(a, function(a) { b._prepend.call(b, a) })
      },
      _prepend : function(a) {
        db.markForPrepend(a),
    ...
    var Oa = function() { this._queue = [], this._isWaitingForRpsQueue = !1 };
    c(Oa, {
      itemsToBatches : function(a, b, c) {
        for (var c = c || !1, a = c ? a : Ya.toNative(a), d = [], e = 0, f = [],
                 g = !1, h = 0;
             h < a.length; h++)
          f.push(a[h]), g = !1, e++,
      ...
      schedule : function(a, b, c, d,
                          e) { this._schedule(b, e, c, d, a, this._exec) },
      scheduleFnExec : function(a, b, c, d) {
        for (var c = c || H.INSERT_BATCH_DELAY, e = this.itemsToBatches(a, b),
                 f = 0;
             f < e.length; f++)
          !function(a, b) { setTimeout(function() { d(a) }, c * b) }(e[f], f)
      },
      _schedule : function(a, b, c, d, e, f) {
        var g = this, h = function(a) {
          setTimeout(function() { g._execSchedule.call(g, a, b, e, f) }, 0)
        };
        return "undefined" == typeof c
                   ? void h(a)
                   : void this.scheduleFnExec(a, c, d, function(a) { h(a) })
      },
      _execSchedule : function(a, b, c, d) {
        ...
        if (Kb.isEmpty())
          ...
          if (e._queue.push({op : c, items : a, targetItem : b}),
              e._isWaitingForRpsQueue)
            return;
          setTimeout(
              function() { e._isWaitingForRpsQueue = !0, e._process.call(e) },
      ...
      _process : function() {
        for (var a = this, b = !0, c = 0; c < this._queue.length; c++) {
          if (!Kb.isEmpty()) {
            setTimeout(function() { a._process.call(a) }, H.INSERT_QUEUE_DELAY),
                b = !1;
            break
          }
          var d = this._queue[c];
      ...
      _exec : function(a, b, c) {
        c == L.PREPEND      ? Ob.exec(a)
        : c == L.APPEND     ? Nb.exec(a)
        : c == L.INS_BEFORE ? Nb.execInsBefore(a, b)
        : c == L.INS_AFTER  ? Nb.execInsAfter(a, b)
                            : e("wrong op")
      }
    });
    var Pa = function() {};
    c(Pa, {
      exec : function(a, b) {
        ...
        if (0 != a.length) {
          Xa.startCachingTransaction(), Za.ensureCanFit(a),
              a = cb.sort(cb.filter(a));
          for (var c = 0; c < a.length; c++)
            cb.unmarkAsNotCollectable(a[c]), Za.add(a[c]), b(a[c]);
          Xa.stopCachingTransaction(), Za.scheduleResize(), $a.emit(P.INSERT, a)
        }
      },
      execInsertBA : function(a, b, c, d, f, g, h) {
        ...
        if (0 != a.length) {
          ...
          var j = [], b = this._getTargetItem(b, i, d),
    ...
    c(Qa, {
      show : function(a) {
        ...
        for (var c = 0; c < a.length; c++) {
          ...
          this.unmarkAsSchToHide(d.item),
              b.isRendered(d) || (b.markAsRendered(d),
      ...
      renderRepositioned : function(a) { this.render(a, !1) },
      render : function(a, b) {
      ...
      unmarkAsSchToHide : function(a) { Y.rm(a, H.REND.SCH_TO_HIDE_DATA) },
      wasSchToHide : function(a) { return Y.has(a, H.REND.SCH_TO_HIDE_DATA) }
    });
    var Ra = function() {};
    c(Ra, {
      isRendered : function(
          a) { return Y.has(a.item, H.REND.CN_RENDERED_DATA) },
      markAsRendered : function(
          a) { Y.set(a.item, H.REND.CN_RENDERED_DATA, "y") },
      unmarkAsRendered : function(a) { Y.rm(a.item, H.REND.CN_RENDERED_DATA) },
      left : function(a) {
        var b = g("eq", _a);
        if (b("grid", "vertical"))
          var c = a.x1;
        else
          var c = b("intersections", !0) ? a.x1 : a.x1 + a.hOffset;
        return c + "px"
      },
      top : function(a) {
        var b = g("eq", _a);
    ...
    var Sa = function() { this._queue = null, this._queueTimeout = null };
    c(Sa, {
      _reinit : function() {
        null == this._queue ? this._queue = []
      ...
      schedule : function(a, b, c, d, e) {
        if (this._reinit(), a != M.SHOW || !Bb.isScheduled(b.item)) {
          ...
          this._queue.push({op : a, cn : b, left : c, top : d, delay : e}),
              this._queueTimeout = setTimeout(function() { f._process.call(f) },
                                              H.RENDER_QUEUE_DELAY)
        }
      },
      _getApi : function() {
        return {
          toggle: Rb, cc: _a.getApi("coordsChanger"), grid: Za.get(), sr: Z,
              srManager: Xa, collect: cb, prefix: X, dom: Y, getS: g("get", _a),
              EVENT: P, TOGGLE: I, ROTATE: J
        }
      },
      _process : function() {
        for (var a = 0; a < this._queue.length; a++) {
          ...
          if (!Bb.isScheduled(b.cn.item)) {
            if (b.op == M.SHOW) {
              if (!Ya.isConnected(b.cn.item))
                continue;
              var c = "show"
            } else
              var c = b.op == M.HIDE ? "hide" : "render";
      ...
      _show : function(a, b, c, d) {
        ...
        d.dom.css.set(a.item, {position : "absolute", left : b, top : c}),
            _a.getApi("coordsChanger")(a.item, b, c, e("coordsChangeTime"),
                                       e("coordsChangeTiming"), d.dom, d.prefix,
                                       e, !0),
            $a.emitInternal(Q.BEFORE_SHOW_FOR_RSORT),
            _a.getApi("toggle").show(a.item, b, c, e("toggleTime"),
                                     e("toggleTiming"), $a, Sb, d.dom, d,
                                     {x1 : b, y1 : c})
      },
      _hide : function(a, b, c, d) {
        var e = g("get", _a);
        yb.unmarkAsSchToHide(a.item),
            _a.getApi("toggle").hide(a.item, b, c, e("toggleTime"),
                                     e("toggleTiming"), $a, Sb, d.dom, d,
                                     {x1 : b, y1 : c})
      },
      ...
      _execRender : function(a, b, c, d) {
        ...
        if (Y.has(a, I.IS_ACTIVE_WITH_CC))
          var f = e("toggleTime"), h = e("toggleTiming");
        else
          var f = e("coordsChangeTime"), h = e("coordsChangeTiming");
        ...
        j = function() {}, c(j, {
          ...
          isScheduled : function(a) { return Y.has(a, H.REND.SILENT_DATA) },
          _preUnschedule : function(a) {
            for (var b = 0; b < a.length; b++)
              Y.rm(a[b], H.REND.SILENT_DATA)
          },
          getScheduled : function(a) {
            ...
            for (var c = {
                   ...
                   top : Xa.offsetTop(Za.get())
                     ...
                     d = Xa.viewportDocumentCoords(), e = [], f = 0;
                 f < b.length; f++) {
              var g = sb.find(b[f], !0);
              if (null != g) {
                var h = {
          ...
          exec : function(a, b, c) {
            ...
            var f = this;
            setTimeout(function() { f._exec.call(f, a, b, c) },
                       H.REFLOW_FIX_DELAY)
          },
          _exec : function(a, b, c) {
            if ("undefined" != typeof a && null != a && a)
          ...
          _execByBatches : function(a, b, c, d) {
            if ("undefined" == typeof d)
              var d = H.INSERT_BATCH_DELAY;
            for (var e = Mb.itemsToBatches(a, c),
                     f = Mb.itemsToBatches(b, c, !0), g = 0;
                 g < e.length; g++)
              this._execBatch(e[g], f[g], g * d)
          },
          _execBatch : function(a, b, c) {
            var d = this;
            setTimeout(function() { d._render.call(d, a, b) }, c)
          },
          _render : function(a, b) { this.unschedule(a, b), yb.show(b) }
        });
    var Ta = function() {};
    c(Ta, {
      all : function() {
      ...
      fromFirstSortedCn : function(a) {
        Xa.startCachingTransaction(), this._fromFirstSortedCn(a),
            Xa.stopCachingTransaction()
      },
      from : function(a) { this._from(a) },
      sync : function() {
        var a = rb.get();
        if (!Kb.isEmpty()) {
          ...
          sb.syncParams(c);
          for (var d = 0; d < b.queue.length; d++)
            a.push(b.queue[d].cn)
        }
      },
      _stop : function() {
      ...
      _all : function() {
        this.sync();
        var a = rb.get();
        0 != a.length && (a = vb.sortForReappend(a), db.unmarkFirstPrepended(),
      ...
      _fromFirstSortedCn : function(a) {
        for (var b = this._stop(), c = rb.get(), d = [], e = 0; e < a.length;
             e++) {
          for (var f = 0; f < c.length; f++)
      ...
      _start : function(a) {
        lb.recreateForFirst(a.firstCn.item, a.firstCn), Kb.init(a.items, a.cns),
            Kb.start()
      }
    });
    var Ua = function() {};
        ...
        for (var c = rb.get(), d = g("eq", _a), e = 0; e < c.length; e++)
          if (!c[e].restrictCollect)
            if (d("sortDispersion", !1) && d("intersections", !0))
              ...
              d("sortDispersion", !0) && this._getSDCond(c[e], b) &&
                  (a.push(c[e]), c.splice(e, 1), e--);
      ...
      _getSDCond : function(a, b) {
        ...
        if (c("grid", "vertical"))
          if (c("append", "default"))
            ...
            var d = a.y1 > b.y1 || a.y1 == b.y1 && a.x1 <= b.x2;
        else if (c("append", "default"))
          var d = a.x1 > b.x1 || a.x1 == b.x1 && a.y1 >= b.y1;
        else
          var d = a.x1 > b.x1 || a.x1 == b.x1 && a.y1 <= b.y2;
        return d
      },
    ...
    var Va = function() {
      this._queue = null, this._nextBatchTimeout = null, this._queueData = null,
      this._repositionStart =
          {gridX2 : 0, gridY2 : 0, vpWidth : null, vpHeight : null}
    };
    c(Va, {
      isEmpty : function() { return null == this._nextBatchTimeout },
      init : function(a, b) {
      ...
      stop : function() {
        return clearTimeout(this._nextBatchTimeout),
               this._nextBatchTimeout = null, {
          queue: this._queue, queueData: this._queueData
        }
      },
      start : function() {
        this._repositionStart = {
      ...
      getQueued : function() { return this._queue },
      _isSameRepositionProcess : function() {
        var a = !0;
        return _a.eq("grid", "vertical")
                   ? (this._repositionStart.gridX2 != Za.x2() && (a = !1),
                      this._repositionStart.vpWidth != Xa.viewportWidth() &&
                          (a = !1))
      ...
      _processQueue : function(a) {
        return this._queueData =
                   this._queueData.concat(this._queue.splice(0, a)),
      ...
      _scheduleNextBatchReposition : function() {
        ...
        this._nextBatchTimeout =
            setTimeout(function() { a._repositionNextBatch.call(a, !0) },
                       _a.get("queueDelay"))
      },
      _repositionItem : function(
          a) { _a.eq("append", "reversed") ? Eb.position(a) : Cb.position(a) }
    }),
        Y.init(), Z.init();
    var Wa = this, Xa = new pa, Ya = new na, Za = new La, $a = new ua,
        _a = new S, ab = new ta, bb = g("eq", _a), cb = new la, db = new ma,
        eb = new k, fb = new ya, gb = new wa, hb = new l, ib = new da,
        jb = new ea, kb = new fa, lb = new ga, mb = new ha, nb = new ia,
        ob = new ja, pb = new ka, qb = bb("grid", "vertical") ? new Ha : new Ba,
        rb = bb("grid", "vertical") ? new Ga : new Aa, sb = new $, tb = new _,
        ub = new aa, vb = new ba, wb = new ca, xb = new oa,
        yb = (new va, new Qa), zb = new Ra, Ab = new Sa, Bb = new j,
        Cb = bb("grid", "vertical") ? new Fa : new za,
        Db = bb("grid", "vertical") ? new Ia : new Ca,
        Eb = bb("grid", "vertical") ? new Ja : new Da,
        Fb = bb("grid", "vertical") ? new Ka : new Ea, Gb = new sa, Hb = new qa,
        Ib = new ra, Jb = new Ta, Kb = new Va, Lb = new Ua, Mb = new Oa,
        Nb = new Ma, Ob = new Na, Pb = new Pa, Qb = (new R, new T, new h),
        Rb = new U, Sb = new V, Tb = new A, Ub = new z, Vb = new C, Wb = new E,
        Xb = new B;
    return this
  };
  return a
...
(function(q, y, z) {
var t = z(q, q.jQuery);
"undefined" !== typeof module && "exports" in module ? module.exports = t
: "function" === typeof define && define.amd
    ? define([], function() { return t })
    : q[y] = t
})(this, "jdenticon", function(q, y) {
function z(a, b, c) {
  for (var d = document.createElementNS("http://www.w3.org/2000/svg", b), f = 2;
       f + 1 < arguments.length; f += 2)
    d.setAttribute(arguments[f], arguments[f + 1]);
  a.appendChild(d)
}
function t(a) {
  this.b = Math.min(Number(a.getAttribute("width")) || 100,
...
function K(a) {
  this.b = a;
  this.a = '\x3csvg xmlns\x3d"http://www.w3.org/2000/svg" width\x3d"' + a +
           '" height\x3d"' + a + '" viewBox\x3d"0 0 ' + a + " " + a +
...
function N(a) {
  return function(a) {
    ...
    for (var b = 1732584193, d = 4023233417, f = 2562383102, e = 271733878,
             h = 3285377520, k = [ b, d, f, e, h ], g = 0;
         g < a.length; g++) {
      ...
      for (l = 0; 80 > l; l++)
        A = (b << 5 | b >>> 27) +
            (20 > l   ? (d & f ^ ~d & e) + 1518500249
             : 40 > l ? (d ^ f ^ e) + 1859775393
             : 60 > l ? (d & f ^ d & e ^ f & e) + 2400959708
                      : (d ^ f ^ e) + 3395469782) +
            h + u[l],
        h = e, e = f, f = d << 30 | d >>> 2, d = b, b = A | 0;
      k[0] = b = k[0] + b | 0;
      k[1] = d = k[1] + d | 0;
      k[2] = f = k[2] + f | 0;
      k[3] = e = k[3] + e | 0;
...
function r(a, b, c) { return parseInt(a.substr(b, c), 16) }
function p(a) { return (10 * a + .5 | 0) / 10 }
function L() { this.j = "" }
function G(a) {
  this.b = {};
  this.h = a;
...
function P(a, b) {
  a = b.O(a);
  return [
    m.i(a, b.H, b.G(0)), m.i(a, b.v, b.u(.5)), m.i(a, b.H, b.G(1)),
    m.i(a, b.v, b.u(1)), m.i(a, b.v, b.u(0))
  ]
}
function B(a, b) {
  this.x = a;
...
function H(a, b, c, d, f, e, h) {
  ...
  f -= 2 * e;
  var m = new M(a), l = 0 | f / 4;
  c += 0 | e + f / 2 - 2 * l;
  d += 0 | e + f / 2 - 2 * l;
  var p = P(r(b, -7) / 268435455, h), n = [];
  for (f = 0; 3 > f; f++) {
...
function J() {
  ...
  var b = n.config || q.jdenticon_config || {}, c = b.lightness || {},
      d = b.saturation || {}, f = "color" in d ? d.color : d;
  d = d.grayscale;
  return {
    O:
        function(a) {
        ...
        v: "number" == typeof f ? f : .5, H: "number" == typeof d ? d : 0,
        u: a("color", [ .4, .8 ]), G: a("grayscale", [ .3, .9 ]),
        C: m.parse(b.backColor)
  }
}
function C(a) { return /^[0-9a-f]{11,}$/i.test(a) && a }
function D(a) { return N(null == a ? "" : "" + a) }
function x(a, b, c) {
  if ("string" === typeof a) {
    if (g.J) {
    ...
    if (b = C(b) || null != b && D(b) || C(a.getAttribute(g.s)) ||
            a.hasAttribute(g.o) && D(a.getAttribute(g.o)))
      a = d == g.B ? new G(new t(a)) : new E(a.getContext("2d")),
      H(a, b, 0, 0, a.a, c, J())
}
function n() { g.J && x(g.A) }
function Q() {
...
t.prototype = {
  m : function(a, b) {
    b && z(this.a, "rect", "width", "100%", "height", "100%", "fill", a,
           "opacity", b)
  },
  c : function(a, b) { z(this.a, "path", "fill", a, "d", b) }
};
K.prototype = {
  m : function(a, b) {
    b && (this.a += '\x3crect width\x3d"100%" height\x3d"100%" fill\x3d"' + a +
                    '" opacity\x3d"' + b.toFixed(2) + '"/\x3e')
  },
  c : function(
      a, b) { this.a += '\x3cpath fill\x3d"' + a + '" d\x3d"' + b + '"/\x3e' },
  toString : function() { return this.a + "\x3c/svg\x3e" }
};
var g = {
  B : 1,
  L : 2,
  ...
  w : function(a) {
    if (a) {
      ...
      if (/svg/i.test(b))
        return g.B;
      if (/canvas/i.test(b) && "getContext" in a)
        return g.L
    }
  }
};
...
E.prototype = {
  ...
  finish : function() { this.b.restore() }
};
var m = {
  P : function(a, b, c) { return "#" + v(a) + v(b) + v(c) },
  parse : function(a) {
  ...
  K : function(a) {
    var b = r(a, 7, 2);
    return isNaN(b) ? a
                    : "rgba(" + r(a, 1, 2) + "," + r(a, 3, 2) + "," +
                          r(a, 5, 2) + "," + (b / 255).toFixed(2) + ")"
  },
  N : function(a, b, c) {
    if (0 == b)
      return a = v(255 * c), "#" + a + a + a;
    b = .5 >= c ? c * (b + 1) : c + b - c * b;
    c = 2 * c - b;
  ...
  i : function(a, b, c) {
    ...
    return m.N(a, b, .5 > c ? c * d * 2 : d + (c - .5) * (1 - d) * 2)
  }
},
    I = {
      M : [
        ...
        function(a, b) { a.b(b / 2, b / 2, b / 2, b / 2, 3) },
        function(a, b) {
          a.a(0, 0, b, b / 2);
          a.a(0, b / 2, b / 2, b / 2);
      ...
      I : [
        function(a, b) { a.b(0, 0, b, b, 0) },
        function(a, b) { a.b(0, b / 2, b, b / 2, 0) },
        function(a, b) { a.l(0, 0, b, b) },
        function(a, b) {
          var c = b / 6;
          a.g(c, c, b - 2 * c)
        }
...
L.prototype = {
  ...
  g : function(a, b, c) {
    c = c ? 0 : 1;
    var d = p(b / 2), f = p(b);
    this.j += "M" + p(a.x) + " " + p(a.y + b / 2) + "a" + d + "," + d +
              " 0 1," + c + " " + f + ",0a" + d + "," + d + " 0 1," + c + " " +
              -f + ",0"
  }
};
G.prototype = {
  ...
  D : function(a) { this.c = this.b[a] || (this.b[a] = new L) },
  F : function() {},
  f : function(a) { this.c.f(a) },
  g : function(a, b, c) { this.c.g(a, b, c) },
  finish : function() {
    for (var a in this.b)
...
M.prototype = {
  ...
  g : function(a, b, c, d) { this.h.g(this.c.l(a, b, c, c), c, d) },
  ...
  l : function(a, b, c, d, f) {
    this.f([ a + c / 2, b, a + c, b + d / 2, a + c / 2, b + d, a, b + d / 2 ],
           f)
  }
};
w.prototype = {
  l : function(a, b, c, d) {
    ...
    return 1 === this.a   ? new B(f - b - (d || 0), this.c + a)
           : 2 === this.a ? new B(f - a - (c || 0), e - b - (d || 0))
           : 3 === this.a ? new B(this.b + b, e - a - (c || 0))
...
y && (y.fn.jdenticon = function(a, b) {
  this.each(function(c, d) { x(d, a, b) });
  return this
});
  ...
  return function s(m, t, u) {
    function r(o, a) {
      if (!t[o]) {
        ...
        var n = t[o] = {exports : {}};
        m[o][0].call(n.exports, function(a) { return r(m[o][1][a] || a) }, n,
                     n.exports, s, m, t, u)
      }
      return t[o].exports
    }
    for (var p = "function" == typeof require && require, a = 0; a < u.length;
         a++)
      r(u[a]);
    return r
  }({
    ...
    2 : [
      function(a, o, r) {
        ...
        k.rules = a("./data/rules.json").map(function(a) {
          return {
            rule: a, suffix: a.replace(/^(\*\.|\!)/, ""), punySuffix: -1,
                wildcard: "*" === a.charAt(0), exception: "!" === a.charAt(0)
          }
        }),
        k.endsWith = function(
        ...
        k.findRule =
          ...
          return k.rules.reduce(function(a, o) {
            return -1 === o.punySuffix && (o.punySuffix = p.toASCII(o.suffix)),
                   k.endsWith(i, "." + o.punySuffix) || i === o.punySuffix ? o
                                                                           : a
          }, null)
        },
        r.errorCodes = {
        ...
        k.validate = function(a) {
          ...
          var i = k.validate(o);
          if (i)
            return {input : a, error : {message : r.errorCodes[i], code : i}};
          var e = {
            input : a,
            tld : null,
            sld : null,
          ...
          if (!m)
            return n.length < 2 ? e
                                : (e.tld = n.pop(), e.sld = n.pop(),
                                   e.domain = [ e.sld, e.tld ].join("."),
                                   n.length && (e.subdomain = n.pop()), s());
          e.listed = !0;
          var t = m.suffix.split("."), u = n.slice(0, n.length - t.length);
          return m.exception && u.push(t.shift()),
                 e.tld = t.join("."),
                 u.length
                     ? (m.wildcard && (t.unshift(u.pop()), e.tld = t.join(".")),
                        u.length && (e.sld = u.pop(),
                                     e.domain = [ e.sld, e.tld ].join("."),
      ...
      function(a, T, D) {
        (function(S) {
          !function(a) {
            ...
            var n, s,
                d = 2147483647, b = 36, y = 1, f = 26, m = 38, t = 700, v = 72,
                w = 128, z = "-", u = /^xn--/, r = /[^\x20-\x7E]/,
                p = /[\x2E\u3002\uFF0E\uFF61]/g, k = {
                ...
                c = b - y, x = Math.floor, q = String.fromCharCode;
            function A(a) { throw new RangeError(k[a]) }
            function g(a, o) {
            ...
            function L(a, o) { return a + 22 + 75 * (a < 26) - ((0 != o) << 5) }
            function I(a, o, i) {
              var e = 0;
              for (a = i ? x(a / t) : a >> 1, a += x(a / o); c * f >> 1 < a;
                   e += b)
                a = x(a / c);
              return x(e + (c + 1) * a / (a + m))
            }
            function h(a) {
              var o, i, e, n, s, m, t, u, r, p, k, c = [], g = a.length, l = 0,
                                                   h = w, j = v;
              for ((i = a.lastIndexOf(z)) < 0 && (i = 0), e = 0; e < i; ++e)
                128 <= a.charCodeAt(e) && A("not-basic"),
                    c.push(a.charCodeAt(e));
              for (n = 0 < i ? i + 1 : 0; n < g;) {
                for (s = l, m = 1, t = b; g <= n && A("invalid-input"),
                    k = a.charCodeAt(n++),
                    (b <= (u = k - 48 < 10   ? k - 22
                               : k - 65 < 26 ? k - 65
                               : k - 97 < 26 ? k - 97
                                             : b) ||
                     u > x((d - l) / m)) && A("overflow"),
                    l += u * m,
                    !(u < (r = t <= j       ? y
                               : j + f <= t ? f
                                            : t - j));
                ...
                x(l / o) > d - h && A("overflow"), h += x(l / o), l %= o,
                c.splice(l++, 0, h)
              }
              return _(c)
            }
            function j(a) {
              var o, i, e, n, s, m, t, u, r, p, k, c, g, l, h, j = [];
              for (c = (a = O(a)).length, o = w, s = v, m = i = 0; m < c; ++m)
                (k = a[m]) < 128 && j.push(q(k));
              for (e = n = j.length, n && j.push(z); e < c;) {
                for (t = d, m = 0; m < c; ++m)
                  o <= (k = a[m]) && k < t && (t = k);
                for (t - o > x((d - i) / (g = e + 1)) && A("overflow"),
                     i += (t - o) * g, o = t, m = 0;
                     m < c; ++m)
                  if ((k = a[m]) < o && ++i > d && A("overflow"), k == o) {
                    for (u = i, r = b; !(u < (p = r <= s       ? y
                                                  : s + f <= r ? f
                                                               : r - s));
                         r += b)
                      h = u - p, l = b - p, j.push(q(L(p + h % l, 0))),
                      u = x(h / l);
            ...
            if (n = {
                  ...
                  toASCII : function(a) {
                    return l(
                        a, function(a) { return r.test(a) ? "xn--" + j(a) : a })
                  },
...
function setup_grid() {
  ...
  } else if (typeof localStorage.useCustomTiles == "undefined" ||
  ...
  grid.onShow(function(item) { swap_if_ready(); });

  grid.onReposition(function(items) { save_grid_snapshot(); });
  ...
  grid.onDisconnect(function(item) {
    ...
    window.setTimeout(function() { save_grid_snapshot(); }, 500);
    localStorage.useCustomTiles = "true";
    console.log("Item removed");
  });

  if (!document.areIdeasFetched &&
    ...
    fetch('https://tiles.kiwibrowser.org/ideas/?version=2&cachebuster=' +
              Math.random(),
          {method : 'GET'})
        ...
        .then(function(answer) {
          for (var i = 0; i < answer.length; i++) {
            add_favorite_idea(answer[i].name, answer[i].click_url,
                              answer[i].impression_url, answer[i].image_url);
          }
          if (answer.length > 0)
...
try {
  window.setTimeout(function() { setup_grid(); }, 2);
} catch (err) {
