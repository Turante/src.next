...
public class ThemeSettingsFragment extends PreferenceFragmentCompat {
  ...
  public void onCreatePreferences(@Nullable Bundle savedInstanceState,
    ...
    radioButtonGroupThemePreference.setOnPreferenceChangeListener((preference,
                                                                   newValue)
                                                                      -> {
      if (false)
    ...
    // TODO(crbug.com/1252868): Notify feature engagement system that settings
    // were opened. Record entry point metrics if this fragment is freshly
    // created.
  ...
  public void onActivityCreated(Bundle savedInstanceState) {
    ...
    // On O_MR1, the flag View.SYSTEM_UI_FLAG_LIGHT_NAVIGATION_BAR in this
    // fragment is not updated to the attribute android:windowLightNavigationBar
    // set in preference theme, so we set the flag explicitly to workaround the
    // issue. See https://crbug.com/942551.
