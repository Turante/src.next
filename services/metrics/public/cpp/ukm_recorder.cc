...
// static
ukm::SourceId UkmRecorder::GetNewSourceID() { return AssignNewSourceId(); }
...
// static
ukm::SourceId
UkmRecorder::GetSourceIdForWebApkManifestUrl(const GURL &manifest_url) {
...
// static
ukm::SourceId
UkmRecorder::GetSourceIdForDesktopWebAppStartUrl(const GURL &start_url) {
  ukm::SourceId source_id =
...
void UkmRecorder::RecordAppURL(ukm::SourceIdObj source_id, const GURL &url,
